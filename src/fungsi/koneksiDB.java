...
public class koneksiDB {
    ...
    private static void initDataSource() throws Exception {
        ...
        dataSource.setURL("jdbc:mysql://" + EnkripsiAES.decrypt(prop.getProperty("HOST")) + ":"
                ...
                + "?zeroDateTimeBehavior=convertToNull&tcpKeepAlive=true&connectTimeout=100000&socketTimeout=600000&maintainTimeStats=false&autoReconnect=true");
            ...
            try {
                ...
                if (retries == 0) {
                    JOptionPane.showMessageDialog(null,
                            "Koneksi ke database gagal. Silakan periksa koneksi jaringan atau konfigurasi database.");
