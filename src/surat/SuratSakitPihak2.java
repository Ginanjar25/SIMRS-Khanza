...
public final class SuratSakitPihak2 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakSuratSakit2.setText("Cetak Surat Keterangan Dokter Pihak Ke 2");
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-08-2024" }));
        ...
        TglLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-08-2024" }));
        ...
        cmbHubungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Suami", "Istri", "Anak", "Ayah", "Saudara", "Keponakan", "Ibu" }));
        ...
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-08-2024" }));
    ...
    private void MnCetakSuratSakit2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakit2ActionPerformed
       if(TPasien.getText().trim().equals("")){
        ...
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("sip_dokter",Sequel.cariIsi("select no_ijn_praktek from dokter where kd_dokter = ?", kodedokter));
                Valid.MyReportqry("rptSuratSakitPihakKe2.jasper","report","::[ Surat Sakit Pihak Ke 2 ]::",
                              ...
                              " DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y')as tgl_registrasi,pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.pekerjaan,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat, COALESCE(dr2.nm_dokter, '"+namadokter+"') AS dpjp " +
                              ...
                              " and suratsakitpihak2.no_rawat=reg_periksa.no_rawat and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab left JOIN dpjp_ranap dpj ON dpj.no_rawat = suratsakitpihak2.no_rawat left JOIN dokter dr2 ON dr2.kd_dokter = dpj.kd_dokter "+
