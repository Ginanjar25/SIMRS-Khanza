...
public final class RMCatatanPersalinan extends javax.swing.JDialog {
    ...
    public RMCatatanPersalinan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[] {
                "No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Dokter", "Dokter Penanggung Jawab",
                "NIP", "Nama Bidan", "Mulai Persalinan", "Selesai Persalinan",
                "Catatan Persalinan", "W.P.Kala 1", "W.P.Kala 2", "W.P.Kala 3", "W.P.Jumlah", "Perineum",
                "Jahitan Luar 1", "Jahitan Luar 2", "Jahitan Dalam 1", "Jahitan Dalam 2",
                "J.K. Anak", "Status Lahir", "APGAR Score", "BB(gram)", "PB(cm)", "Kelainan", "Ketuban", "Placenta",
                "Ukuran(gr)", "Tali Pusat(cm)", "Insertio", "D.K.Kala 1",
                "D.K.Kala 2", "D.K.Kala 3", "D.K.Kala 4", "D.K. Jumlah", "Kondisi Umum", "TD(mmHg)", "Nadi(x/menit)",
                "RR(x/menit)", "Suhu(°C)", "Kontraksi Uterus",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Data Catatan Persalinan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
            ...
            if (akses.getkode().equals("Admin Utama")) {
                ...
                if (Sequel.cekTanggalRegistrasi(TanggalRegistrasi.getText(),
                        Valid.SetTgl(WaktuMulai.getSelectedItem() + "") + " "
                                + WaktuMulai.getSelectedItem().toString().substring(11, 19)) == true) {
                    simpan();
                }
            }
        }
        ...
        if (tbObat.getSelectedRow() > -1) {
            if (akses.getkode().equals("Admin Utama")) {
                ...
                if (KdPetugas.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(), 7).toString())) {
                    if (Sequel.cekTanggal48jam(tbObat.getValueAt(tbObat.getSelectedRow(), 9).toString(),
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger2",
                    "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                            ...
                            + (finger.equals("") ? tbObat.getValueAt(tbObat.getSelectedRow(), 7).toString() : finger)
                            + "\n" + Valid.SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(), 9).toString()));
            Valid.MyReportqry("rptCetakCatatanPersalinan.jasper", "report", "::[ Laporan Catatan Persalinan ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,catatan_persalinan.mulai,"
                            ...
                            "inner join petugas on catatan_persalinan.nip=petugas.nip where catatan_persalinan.no_rawat='"
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[] {
                            ...
                            rs.getString("mulai"), rs.getString("selesai"), rs.getString("catatan"),
                            rs.getString("waktu_persalinan_kala_1"), rs.getString("waktu_persalinan_kala_2"),
                            rs.getString("waktu_persalinan_kala_3"), rs.getString("waktu_persalinan_jumlah"),
                            rs.getString("perineum"), rs.getString("jahitan_luar_1"), rs.getString("jahitan_luar_2"),
                            rs.getString("jahitan_dalam_1"), rs.getString("jahitan_dalam_2"), rs.getString("anak"),
                            rs.getString("status_lahir"), rs.getString("apgar_score"),
                            rs.getString("bb"), rs.getString("pb"), rs.getString("kelainan"), rs.getString("ketuban"),
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_persalinan", "no_rawat=?",
                ...
                40, new String[] {
                        ...
                        KdDokter.getText(), KdPetugas.getText(), Catatan.getText(), WaktuPersalinanKala1.getText(),
                        WaktuPersalinanKala2.getText(),
                        WaktuPersalinanKala3.getText(), WaktuPersalinanJumlah.getText(),
                        Perineum.getSelectedItem().toString(), JahitanLuar1.getText(),
                        JahitanLuar2.getText(), JahitanDalam1.getText(), JahitanDalam2.getText(),
                        Anak.getSelectedItem().toString(), StatusLahir.getSelectedItem().toString(),
                        ApgarScore.getText(), BB.getText(), PB.getText(), Kelainan.getText(), Ketuban.getText(),
                        Placenta.getText(), Ukuran.getText(), TaliPusat.getText(),
                        Insertio.getText(), DarahKeluarKala1.getText(), DarahKeluarKala2.getText(),
                        DarahKeluarKala3.getText(), DarahKeluarKala4.getText(),
                        DarahKeluarJumlah.getText(), KondisiUmum.getText(), TD.getText(), Nadi.getText(), RR.getText(),
                        Suhu.getText(), KontraksiUterus.getText(),
    ...
    private void isWaktuPersalinan() {
        if ((!WaktuPersalinanKala1.getText().equals("")) && (!WaktuPersalinanKala2.getText().equals(""))
                && (!WaktuPersalinanKala3.getText().equals(""))) {
            try {
    ...
    private void isDarahKeluar() {
        if ((!DarahKeluarKala1.getText().equals("")) && (!DarahKeluarKala2.getText().equals(""))
                && (!DarahKeluarKala3.getText().equals("")) && (!DarahKeluarKala4.getText().equals(""))) {
            try {
                DarahKeluarJumlah.setText(Valid.SetAngka8(Valid.SetAngka(DarahKeluarKala1.getText())
                        + Valid.SetAngka(DarahKeluarKala2.getText()) + Valid.SetAngka(DarahKeluarKala3.getText())
                        + Valid.SetAngka(DarahKeluarKala4.getText()), 2) + "");
            } catch (Exception e) {
                DarahKeluarJumlah.setText("");
            }
        }
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_persalinan",
            ...
            tabMode.addRow(new Object[] {
                    ...
                    KdDokter.getText(), NmDokter.getText(), KdPetugas.getText(),
                    NmPetugas.getText(),
                    Valid.SetTgl(WaktuMulai.getSelectedItem() + "") + " "
                            + WaktuMulai.getSelectedItem().toString().substring(11, 19),
                    Valid.SetTgl(WaktuSelesai.getSelectedItem() + "") + " "
                            + WaktuSelesai.getSelectedItem().toString().substring(11, 19),
                    Catatan.getText(),
                    WaktuPersalinanKala1.getText(), WaktuPersalinanKala2.getText(), WaktuPersalinanKala3.getText(),
                    WaktuPersalinanJumlah.getText(),
                    Perineum.getSelectedItem().toString(), JahitanLuar1.getText(), JahitanLuar2.getText(),
                    JahitanDalam1.getText(), JahitanDalam2.getText(),
                    Anak.getSelectedItem().toString(), StatusLahir.getSelectedItem().toString(), ApgarScore.getText(),
                    BB.getText(), PB.getText(), Kelainan.getText(),
                    Ketuban.getText(), Placenta.getText(), Ukuran.getText(), TaliPusat.getText(), Insertio.getText(),
                    DarahKeluarKala1.getText(), DarahKeluarKala2.getText(),
                    DarahKeluarKala3.getText(), DarahKeluarKala4.getText(), DarahKeluarJumlah.getText(),
                    KondisiUmum.getText(), TD.getText(), Nadi.getText(),
