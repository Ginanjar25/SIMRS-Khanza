...
public final class RMPenilaianAwalMedisRalanGeriatri extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-06-2024 11:50:18" }));
            ...
            soapterakhir.addWindowListener(new WindowListener() {
                ...
                public void windowClosed(WindowEvent e) {
                    if(soapterakhir.getTable().getSelectedRow()!= -1){
                        ...
                        KondisiUmum.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(),12).toString());
