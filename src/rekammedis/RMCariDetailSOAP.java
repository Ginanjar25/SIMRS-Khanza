 ...
 * @author dosen
 */
public final class RMCariDetailSOAP extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariDetailSOAP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Detail SOAPIE ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TPoli.setPreferredSize(new java.awt.Dimension(150, 23));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariDetailSOAP dialog = new RMCariDetailSOAP(new javax.swing.JFrame(), true);
        ...
        if(!TCari.getText().equals("")){
            try{
                ps=koneksi.prepareStatement(
                        ...
                        "INNER JOIN dokter ON dokter.kd_dokter = reg_periksa.kd_dokter inner join poliklinik ON reg_periksa.kd_poli = poliklinik.kd_poli where \n" +
                        "reg_periksa.no_rawat=? and reg_periksa.kd_poli=? AND pemeriksaan_ralan.nip = ?");
                try{
