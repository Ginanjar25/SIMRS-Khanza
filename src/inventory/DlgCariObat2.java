...
public final class DlgCariObat2 extends javax.swing.JDialog {
    ...
    private String signa1 = "1", signa2 = "1", kdObatSK = "", requestJson = "", nokunjungan = "", URL = "", otorisasi,
            sql = "", no_batchcari = "", tgl_kadaluarsacari = "",
            no_fakturcari = "", aktifkanbatch = "no", aktifpcare = "no", noresep = "", hppfarmasi = "",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Data Obat, Alkes & BHP Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
        ...
        ChkJln.setBounds(360, 40, 22, 23);

        label12.setText("Tarif :");
        label12.setName("label12"); // NOI18N
        label12.setPreferredSize(new java.awt.Dimension(50, 23));
        FormInput.add(label12);
        label12.setBounds(470, 70, 30, 23);

        Jeniskelas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kelas 1", "Kelas 2", "Kelas 3",
        ...
        Jeniskelas.setBounds(500, 70, 110, 23);
        ...
        ChkNoResep.setBounds(620, 70, 85, 23);

        label21.setText("Depo :");
        label21.setName("label21"); // NOI18N
        label21.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label21);
        label21.setBounds(390, 40, 50, 23);
        ...
        kdgudang.setBounds(450, 40, 55, 23);

        nmgudang.setEditable(false);
        nmgudang.setName("nmgudang"); // NOI18N
        nmgudang.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(nmgudang);
        nmgudang.setBounds(510, 40, 120, 23);
        ...
        BtnGudang.setBounds(630, 40, 28, 23);
        ...
        TNoRM1.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(TNoRM1);
        TNoRM1.setBounds(260, 10, 90, 23);
        ...
        TPasien1.setBounds(448, 10, 237, 23);

        jLabel13.setText("Asal Kamar :");
        ...
        TCaraBayar.setBounds(350, 70, 110, 23);
        ...
        if (kdgudang.getText().equals("")) {
            ...
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                try {
                    ...
                    if (i == 8) {
                        try {
                            if (tbObat.getValueAt(tbObat.getSelectedRow(), 8).toString().equals("0")
                                    || tbObat.getValueAt(tbObat.getSelectedRow(), 8).toString().equals("")
                                    || tbObat.getValueAt(tbObat.getSelectedRow(), 8).toString().equals("0.0")
                                    || tbObat.getValueAt(tbObat.getSelectedRow(), 8).toString().equals("0,0")) {
                        ...
                        try {
                            if (tbObat.getValueAt(tbObat.getSelectedRow(), 9).toString().equals("0")
                                    || tbObat.getValueAt(tbObat.getSelectedRow(), 9).toString().equals("")
                                    || tbObat.getValueAt(tbObat.getSelectedRow(), 9).toString().equals("0.0")
                                    || tbObat.getValueAt(tbObat.getSelectedRow(), 9).toString().equals("0,0")) {
                            ...
                            if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                                    ...
                                    if (carikapasitas.next()) {
                                        if (Sequel.menyimpantf2("detail_pemberian_obat", "?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                                "data", 14, new String[] {
                                                        ...
                                                        "" + Math.round(Double
                                                                .parseDouble(tbObat.getValueAt(i, 8).toString()) +
                                            ...
                                            ttljual = ttljual + Math.round(Double
                                                    .parseDouble(tbObat.getValueAt(i, 8).toString()) +
                                                    Double.parseDouble(tbObat.getValueAt(i, 9).toString())
                                                    + (Double.parseDouble(tbObat.getValueAt(i, 6).toString()) *
                                                            (Double.parseDouble(tbObat.getValueAt(i, 1).toString())
                                                                    / carikapasitas.getDouble(1))));
                                            ttlhpp = ttlhpp + Math
                                                    .round(Double.parseDouble(tbObat.getValueAt(i, 12).toString()) *
                                                            (Double.parseDouble(tbObat.getValueAt(i, 1).toString())
                                                                    / carikapasitas.getDouble(1)));
                                            ...
                                            if (aktifkanbatch.equals("yes")) {
                                                Sequel.mengedit("data_batch",
                                                        "no_batch=? and kode_brng=? and no_faktur=?", "sisa=sisa-?", 4,
                                                        new String[] {
                                                                "" + (Double
                                                                        .parseDouble(tbObat.getValueAt(i, 1).toString())
                                                                        / carikapasitas.getDouble(1)),
                                                                tbObat.getValueAt(i, 16).toString(),
                                                                tbObat.getValueAt(i, 2).toString(),
                                                                tbObat.getValueAt(i, 17).toString()
                                                        });
                                                Trackobat.catatRiwayat(tbObat.getValueAt(i, 2).toString(), 0,
                                                        (Double.parseDouble(tbObat.getValueAt(i, 1).toString())
                                                                / carikapasitas.getDouble(1)),
                                                        "Pemberian Obat", akses.getkode(), kdgudang.getText(), "Simpan",
                                                        tbObat.getValueAt(i, 16).toString(),
                                                        tbObat.getValueAt(i, 17).toString(), TNoRw.getText() + " "
                                                ...
                                                Sequel.menyimpan("gudangbarang", "'"
                                                        ...
                                                        "stok=stok-'" + (Double
                                                                .parseDouble(tbObat.getValueAt(i, 1).toString())
                                                                / carikapasitas.getDouble(1)) + "'",
                                                        "kode_brng='" + tbObat.getValueAt(i, 2).toString()
                                ...
                                if (Sequel.menyimpantf2("detail_pemberian_obat", "?,?,?,?,?,?,?,?,?,?,?,?,?,?", "data",
                                        14, new String[] {
                                                ...
                                                "" + Math.round(Double.parseDouble(tbObat.getValueAt(i, 8).toString()) +
                                                        Double.parseDouble(tbObat.getValueAt(i, 9).toString())
                                                        + (Double.parseDouble(tbObat.getValueAt(i, 6).toString()) *
                                                                Double.parseDouble(
                                                                        tbObat.getValueAt(i, 1).toString()))),
                                    ...
                                    ttljual = ttljual
                                            + Math.round(Double.parseDouble(tbObat.getValueAt(i, 8).toString()) +
                                                    ...
                                                    + (Double.parseDouble(tbObat.getValueAt(i, 6).toString()) *
                                                            Double.parseDouble(tbObat.getValueAt(i, 1).toString())));
                                    ttlhpp = ttlhpp
                                            + Math.round(Double.parseDouble(tbObat.getValueAt(i, 12).toString()) *
                                                    Double.parseDouble(tbObat.getValueAt(i, 1).toString()));
                                    if (!tbObat.getValueAt(i, 13).toString().equals("")) {
                                        Sequel.menyimpan("aturan_pakai", "?,?,?,?,?", 5, new String[] {
                                                Valid.SetTgl(DTPTgl.getSelectedItem() + ""),
                                    ...
                                    if (aktifkanbatch.equals("yes")) {
                                        ...
                                        Sequel.menyimpan("gudangbarang",
                                                "'" + tbObat.getValueAt(i, 2).toString() + "','" + kdgudang.getText()
                                                        + "','-"
                                                        + Double.parseDouble(tbObat.getValueAt(i, 1).toString()) + "','"
                                                        + tbObat.getValueAt(i, 16).toString() + "','"
                                                        + tbObat.getValueAt(i, 17).toString() + "'",
                                                "stok=stok-'" + Double.parseDouble(tbObat.getValueAt(i, 1).toString())
                                                        + "'",
                                                "kode_brng='" + tbObat.getValueAt(i, 2).toString()
                                                        + "' and kd_bangsal='" + kdgudang.getText() + "' and no_batch='"
                                                        + tbObat.getValueAt(i, 16).toString() + "' and no_faktur='"
                                                        + tbObat.getValueAt(i, 17).toString() + "'");
                                    } else {
                                        Trackobat.catatRiwayat(tbObat.getValueAt(i, 2).toString(), 0,
                                                Double.parseDouble(tbObat.getValueAt(i, 1).toString()),
                                                "Pemberian Obat", akses.getkode(), kdgudang.getText(), "Simpan", "", "",
                                                TNoRw.getText() + " " + TNoRM.getText() + " " + TPasien.getText());
                                        Sequel.menyimpan("gudangbarang", "'" + tbObat.getValueAt(i, 2).toString()
                                                + "','" + kdgudang.getText() + "','-"
                                                + Double.parseDouble(tbObat.getValueAt(i, 1).toString()) + "','',''",
                                                "stok=stok-'" + Double.parseDouble(tbObat.getValueAt(i, 1).toString())
                                                        + "'",
                        ...
                        if (Valid.SetAngka(tbDetailObatRacikan.getValueAt(i, 10).toString()) > 0) {
                            if (Sequel.menyimpantf2("detail_obat_racikan", "?,?,?,?,?", "Data", 5, new String[] {
                                ...
                                if (Sequel
                                        .menyimpantf2("detail_pemberian_obat", "?,?,?,?,?,?,?,?,?,?,?,?,?,?", "data",
                                                14, new String[] {
                                                        ...
                                                        "" + Math.round(Double.parseDouble(
                                                                tbDetailObatRacikan.getValueAt(i, 11).toString()) +
                                                                Double.parseDouble(tbDetailObatRacikan.getValueAt(i, 12)
                                                                        .toString())
                                                                +
                                                                (Double.parseDouble(
                                                                        tbDetailObatRacikan.getValueAt(i, 4).toString())
                                                                        *
                                                                        Double.parseDouble(tbDetailObatRacikan
                                    ...
                                    ttljual = ttljual + Math.round(Double
                                            .parseDouble(tbDetailObatRacikan.getValueAt(i, 11).toString()) +
                                            ...
                                            + (Double.parseDouble(tbDetailObatRacikan.getValueAt(i, 4).toString()) *
                                                    Double.parseDouble(
                                                            tbDetailObatRacikan.getValueAt(i, 10).toString())));
                                    ttlhpp = ttlhpp + Math.round(Double
                                            .parseDouble(tbDetailObatRacikan.getValueAt(i, 5).toString()) *
                    ...
                    if (sukses == true) {
                        ...
                        if (ttljual > 0) {
                            if (Sequel.menyimpantf2("tampjurnal",
                                    "'" + akunobatranap.getSuspen_Piutang_Obat_Ranap()
                                            + "','Suspen Piutang Obat Ranap','" + ttljual + "','0'",
                                    "Rekening") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf2(
                                    "tampjurnal", "'" + akunobatranap.getObat_Ranap()
                                            + "','Pendapatan Obat Rawat Inap','0','" + ttljual + "'",
                                    "Rekening") == false) {
                                sukses = false;
                            }
                        }
                        if (ttlhpp > 0) {
                            if (Sequel.menyimpantf2("tampjurnal",
                                    "'" + akunobatranap.getHPP_Obat_Rawat_Inap()
                                            + "','HPP Persediaan Obat Rawat Inap','" + ttlhpp + "','0'",
                                    "Rekening") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf2("tampjurnal",
                                    "'" + akunobatranap.getPersediaan_Obat_Rawat_Inap()
                                            + "','Persediaan Obat Rawat Inap','0','" + ttlhpp + "'",
                                    "Rekening") == false) {
                                sukses = false;
                            }
                        }
                        if (sukses == true) {
                            if ((ttljual > 0) || (ttlhpp > 0)) {
                                sukses = jur.simpanJurnal(TNoRw.getText(), "U",
                                        "PEMBERIAN OBAT RAWAT INAP PASIEN " + TNoRw.getText() + " " + TNoRM.getText()
                    ...
                    if (sukses == true) {
                        ...
                        if (ChkNoResep.isSelected() == true) {
                            ...
                            resep.setNoRm(TNoRw.getText(), DTPTgl.getDate(), DTPTgl.getDate(),
                                    ...
                                    cmbDtk.getSelectedItem().toString(), "ranap");
                            resep.tampil2();
    ...
    private void ChkNoResepItemStateChanged(java.awt.event.ItemEvent evt) {// GEN-FIRST:event_ChkNoResepItemStateChanged
        if (ChkNoResep.isSelected() == true) {
            ...
            if (!ResepObat.isVisible()) {
                ResepObat.emptTeks();
                ResepObat.isCek();
                ResepObat.setNoRm(TNoRw.getText(), DTPTgl.getDate(), DTPTgl.getDate(),
                        cmbJam.getSelectedItem().toString(), cmbMnt.getSelectedItem().toString(),
            ...
            lokasidepo.addWindowListener(new WindowAdapter() {
                ...
                public void windowClosed(WindowEvent e) {
                    if (lokasidepo.getTable().getSelectedRow() != -1) {
                        kdgudang.setText(
                                lokasidepo.getTable().getValueAt(lokasidepo.getTable().getSelectedRow(), 0).toString());
                        nmgudang.setText(
                                lokasidepo.getTable().getValueAt(lokasidepo.getTable().getSelectedRow(), 1).toString());
                    }
            ...
            if (tbDetailObatRacikan.getRowCount() != 0) {
                ...
                if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                    try {
                        if (i == 11) {
                            try {
                                if (tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 11).toString()
                                        .equals("0")
                                        || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 11)
                                                .toString().equals("")
                                        || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 11)
                                                .toString().equals("0.0")
                                        || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 11)
                                                .toString().equals("0,0")) {
                                    tbDetailObatRacikan.setValueAt(embalasetuslah.getEmbalase(),
                            ...
                            try {
                                if (tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 12).toString()
                                        .equals("0")
                                        || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 12)
                                                .toString().equals("")
                                        || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 12)
                                                .toString().equals("0.0")
                                        || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 12)
                                                .toString().equals("0,0")) {
                                    tbDetailObatRacikan.setValueAt(embalasetuslah.getTuslah(),
                            ...
                            try {
                                if (!tabModeDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 9)
                                        .toString().equals("")) {
                                    tbDetailObatRacikan.setValueAt(
                                            Valid.SetAngka8((Double
                                                    .parseDouble(tbObatRacikan
                                                            .getValueAt(tbObatRacikan.getSelectedRow(), 4).toString())
                                                    * Double.parseDouble(tbDetailObatRacikan
                                                            .getValueAt(tbDetailObatRacikan.getSelectedRow(), 9)
                                                            .toString()))
                                                    / Double.parseDouble(tbDetailObatRacikan
                                                            .getValueAt(tbDetailObatRacikan.getSelectedRow(), 8)
                                                            .toString()),
                                                    1),
                    ...
                    try {
                        if ((i == 9) || (i == 10)) {
                            if (!tabModeDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 9).toString()
                                    .equals("")) {
                                tbDetailObatRacikan.setValueAt(
                                        Valid.SetAngka8((Double.parseDouble(
                                                tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 4).toString())
                                                * Valid.SetAngka(tbDetailObatRacikan.getValueAt(row, 9).toString()))
                                                / Valid.SetAngka(tbDetailObatRacikan.getValueAt(row, 8).toString()), 1),
                                        row, 10);
                                getDatadetailobatracikan();
                            }
                        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 1).equals("")
                && tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 4).equals("")
                && tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 5).equals("")
                && tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 6).equals("")) {
                ...
                if (aktifkanbatch.equals("yes")) {
                    if (aktifpcare.equals("yes")) {
                        sql = "select data_batch.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(data_batch.h_beli+(data_batch.h_beli*?)) as harga,"
                                ...
                                + hppfarmasi + " as dasar,databarang.kapasitas " +
                    ...
                    psobat = koneksi.prepareStatement(sql
                            + " where gudangbarang.stok>0 and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa asc");
                    try {
                        psobat.setDouble(1, kenaikan);
                        psobat.setString(2, kdgudang.getText());
                        rsobat = psobat.executeQuery();
                        while (rsobat.next()) {
                            iyembuilder.append("{\"KodeBarang\":\"").append(rsobat.getString("kode_brng"))
                                    .append("\",\"NamaBarang\":\"")
                                    .append(rsobat.getString("nama_brng").replaceAll("\"", ""))
                                    .append("\",\"Satuan\":\"").append(rsobat.getString("kode_sat"))
                                    .append("\",\"Kandungan\":\"").append(rsobat.getString("letak_barang"))
                                    .append("\",\"HargaKaryawan\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("harga"), 100))
                                    .append("\",\"HargaBeliLuar\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("harga"), 100))
                                    .append("\",\"HargaKelas1\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("harga"), 100))
                                    .append("\",\"HargaKelas2\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("harga"), 100))
                                    .append("\",\"HargaKelas3\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("harga"), 100)).append("\",\"HargaVIP\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("harga"), 100)).append("\",\"HargaVVIP\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("harga"), 100))
                                    .append("\",\"HargaUtama\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("harga"), 100)).append("\",\"Jenis\":\"")
                                    .append(rsobat.getString("nama")).append("\",\"Kategori\":\"")
                                    .append(rsobat.getString("kategori")).append("\",\"Golongan\":\"")
                                    .append(rsobat.getString("golongan")).append("\",\"IndustriFarmasi\":\"")
                                    .append(rsobat.getString("nama_industri")).append("\",\"HargaBeli\":\"")
                                    .append(rsobat.getDouble("h_beli")).append("\",\"Stok\":\"")
                                    .append(rsobat.getDouble("stok")).append("\",\"Kapasitas\":\"")
                                    .append(rsobat.getDouble("kapasitas")).append("\",\"NoBatch\":\"")
                                    .append(rsobat.getString("no_batch")).append("\",\"NoFaktur\":\"")
                                    .append(rsobat.getString("no_faktur")).append("\",\"Kadaluarsa\":\"")
                                    .append(rsobat.getString("tgl_kadaluarsa")).append("\"},");
                        }
                    } catch (Exception e) {
                    ...
                    psobat = koneksi.prepareStatement(sql
                            + " where gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.stok>0 and gudangbarang.kd_bangsal=? and databarang.status='1' order by databarang.nama_brng");
                    try {
                        psobat.setDouble(1, kenaikan);
                        psobat.setString(2, kdgudang.getText());
                        rsobat = psobat.executeQuery();
                        while (rsobat.next()) {
                            iyembuilder.append("{\"KodeBarang\":\"").append(rsobat.getString("kode_brng"))
                                    ...
                                    .append(rsobat.getDouble("h_beli")).append("\",\"Stok\":\"")
                                    .append(rsobat.getDouble("stok")).append("\",\"Kapasitas\":\"")
                                    .append(rsobat.getDouble("kapasitas"))
                                    .append("\",\"NoBatch\":\"\",\"NoFaktur\":\"\",\"Kadaluarsa\":\"\"},");
                        }
                    } catch (Exception e) {
                        System.out.println("Notifikasi : " + e);
                    } finally {
                    ...
                    try {
                        ...
                        while (rsobat.next()) {
                            iyembuilder.append("{\"KodeBarang\":\"").append(rsobat.getString("kode_brng"))
                                    ...
                                    .append("\",\"Kandungan\":\"").append(rsobat.getString("letak_barang"))
                                    .append("\",\"HargaKaryawan\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("karyawan"), 100))
                                    .append("\",\"HargaBeliLuar\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("beliluar"), 100))
                                    .append("\",\"HargaKelas1\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("kelas1"), 100))
                                    .append("\",\"HargaKelas2\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("kelas2"), 100))
                                    .append("\",\"HargaKelas3\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("kelas3"), 100)).append("\",\"HargaVIP\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("vip"), 100)).append("\",\"HargaVVIP\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("vvip"), 100)).append("\",\"HargaUtama\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("utama"), 100)).append("\",\"Jenis\":\"")
                                    .append(rsobat.getString("nama")).append("\",\"Kategori\":\"")
                                    .append(rsobat.getString("kategori")).append("\",\"Golongan\":\"")
                                    .append(rsobat.getString("golongan")).append("\",\"IndustriFarmasi\":\"")
                                    .append(rsobat.getString("nama_industri")).append("\",\"HargaBeli\":\"")
    ...
    private void tampilcacheberiobat() {
        try {
            ...
            String[] kodebarang, namabarang, kodesatuan, letakbarang, namajenis, industri, aturan, kategori, golongan,
                    nobatch, nofaktur, kadaluarsa;
            jml = 0;
            for (i = 0; i < tbObat.getRowCount(); i++) {
                if (Valid.SetAngka(tbObat.getValueAt(i, 1).toString()) > 0) {
                    jml++;
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabMode.addRow(new Object[] {
                                    false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                    Double.parseDouble(list.path("HargaKelas1").asText()), list.path("Jenis").asText(),
                                    0, 0, Double.parseDouble(list.path("Stok").asText()),
                                    list.path("IndustriFarmasi").asText(),
                                    Double.parseDouble(list.path("HargaBeli").asText()), "",
                                    list.path("Kategori").asText(),
                                    list.path("Golongan").asText(), list.path("NoBatch").asText(),
                        ...
                        for (JsonNode list : response) {
                            if (list.path("KodeBarang").asText().toLowerCase().contains(cari)
                                    || list.path("NamaBarang").asText().toLowerCase().contains(cari)
                                    || list.path("Jenis").asText().toLowerCase().contains(cari)
                                    || list.path("Kandungan").asText().toLowerCase().contains(cari)
                                    || list.path("NoBatch").asText().toLowerCase().contains(cari)) {
                                tabMode.addRow(new Object[] {
                                        false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                        list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                        Double.parseDouble(list.path("HargaKelas1").asText()),
                                        list.path("Jenis").asText(), 0, 0,
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabMode.addRow(new Object[] {
                                    false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                    Double.parseDouble(list.path("HargaKelas2").asText()), list.path("Jenis").asText(),
                                    0, 0, Double.parseDouble(list.path("Stok").asText()),
                                    list.path("IndustriFarmasi").asText(),
                                    Double.parseDouble(list.path("HargaBeli").asText()), "",
                                    list.path("Kategori").asText(),
                        ...
                        for (JsonNode list : response) {
                            if (list.path("KodeBarang").asText().toLowerCase().contains(cari)
                                ...
                                tabMode.addRow(new Object[] {
                                        false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                        list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                        Double.parseDouble(list.path("HargaKelas2").asText()),
                                        list.path("Jenis").asText(), 0, 0,
                                        Double.parseDouble(list.path("Stok").asText()),
                                        list.path("IndustriFarmasi").asText(),
                                        Double.parseDouble(list.path("HargaBeli").asText()), "",
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabMode.addRow(new Object[] {
                                    false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                    Double.parseDouble(list.path("HargaKelas3").asText()), list.path("Jenis").asText(),
                                    0, 0, Double.parseDouble(list.path("Stok").asText()),
                                    list.path("IndustriFarmasi").asText(),
                                    Double.parseDouble(list.path("HargaBeli").asText()), "",
                                    list.path("Kategori").asText(),
                        ...
                        for (JsonNode list : response) {
                            if (list.path("KodeBarang").asText().toLowerCase().contains(cari)
                                ...
                                tabMode.addRow(new Object[] {
                                        false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                        list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                        Double.parseDouble(list.path("HargaKelas3").asText()),
                                        list.path("Jenis").asText(), 0, 0,
                                        Double.parseDouble(list.path("Stok").asText()),
                                        list.path("IndustriFarmasi").asText(),
                                        Double.parseDouble(list.path("HargaBeli").asText()), "",
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabMode.addRow(new Object[] {
                                    false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                    Double.parseDouble(list.path("HargaUtama").asText()), list.path("Jenis").asText(),
                                    0, 0, Double.parseDouble(list.path("Stok").asText()),
                                    list.path("IndustriFarmasi").asText(),
                                    Double.parseDouble(list.path("HargaBeli").asText()), "",
                                    list.path("Kategori").asText(),
                        ...
                        for (JsonNode list : response) {
                            if (list.path("KodeBarang").asText().toLowerCase().contains(cari)
                                ...
                                tabMode.addRow(new Object[] {
                                        false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                        list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                        Double.parseDouble(list.path("HargaUtama").asText()),
                                        list.path("Jenis").asText(), 0, 0,
                                        Double.parseDouble(list.path("Stok").asText()),
                                        list.path("IndustriFarmasi").asText(),
                                        Double.parseDouble(list.path("HargaBeli").asText()), "",
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabMode.addRow(new Object[] {
                                    false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                    Double.parseDouble(list.path("HargaVIP").asText()), list.path("Jenis").asText(), 0,
                                    0, Double.parseDouble(list.path("Stok").asText()),
                                    list.path("IndustriFarmasi").asText(),
                                    Double.parseDouble(list.path("HargaBeli").asText()), "",
                                    list.path("Kategori").asText(),
                                    list.path("Golongan").asText(), list.path("NoBatch").asText(),
                        ...
                        for (JsonNode list : response) {
                            if (list.path("KodeBarang").asText().toLowerCase().contains(cari)
                                ...
                                tabMode.addRow(new Object[] {
                                        false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                        list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                        Double.parseDouble(list.path("HargaVIP").asText()), list.path("Jenis").asText(),
                                        0, 0, Double.parseDouble(list.path("Stok").asText()),
                                        list.path("IndustriFarmasi").asText(),
                                        Double.parseDouble(list.path("HargaBeli").asText()), "",
                                        list.path("Kategori").asText(),
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabMode.addRow(new Object[] {
                                    false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                    Double.parseDouble(list.path("HargaVVIP").asText()), list.path("Jenis").asText(), 0,
                                    0, Double.parseDouble(list.path("Stok").asText()),
                                    list.path("IndustriFarmasi").asText(),
                                    Double.parseDouble(list.path("HargaBeli").asText()), "",
                                    list.path("Kategori").asText(),
                        ...
                        for (JsonNode list : response) {
                            if (list.path("KodeBarang").asText().toLowerCase().contains(cari)
                                ...
                                tabMode.addRow(new Object[] {
                                        false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                        list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                        Double.parseDouble(list.path("HargaVVIP").asText()),
                                        list.path("Jenis").asText(), 0, 0,
                                        Double.parseDouble(list.path("Stok").asText()),
                                        list.path("IndustriFarmasi").asText(),
                                        Double.parseDouble(list.path("HargaBeli").asText()), "",
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabMode.addRow(new Object[] {
                                    false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                    Double.parseDouble(list.path("HargaBeliLuar").asText()),
                                    list.path("Jenis").asText(), 0, 0, Double.parseDouble(list.path("Stok").asText()),
                                    list.path("IndustriFarmasi").asText(),
                                    Double.parseDouble(list.path("HargaBeli").asText()), "",
                                    list.path("Kategori").asText(),
                                    list.path("Golongan").asText(), list.path("NoBatch").asText(),
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabMode.addRow(new Object[] {
                                    false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                    Double.parseDouble(list.path("HargaKaryawan").asText()),
                                    list.path("Jenis").asText(), 0, 0, Double.parseDouble(list.path("Stok").asText()),
                                    list.path("IndustriFarmasi").asText(),
                                    Double.parseDouble(list.path("HargaBeli").asText()), "",
                                    list.path("Kategori").asText(),
    ...
    public void setNoRm(String norwt, String norm, String pasien, Date tanggal, String jam, String menit, String detik,
        ...
        this.noresep = "";
        TCaraBayar.setText(Sequel.cariIsi(
                "select penjab.png_jawab from reg_periksa INNER JOIN penjab ON penjab.kd_pj = reg_periksa.p_jawab where reg_periksa.no_rawat=?",
                norwt));
        TKamar.setText(Sequel.cariIsi("SELECT bangsal.nm_bangsal FROM kamar_inap " +
                ...
                "WHERE kamar_inap.no_rawat = ?", norwt));
    ...
    public void setNoResep(String no_resep) {
        ...
        TAlergi.setText(Sequel.cariIsi(
                "SELECT TRIM(SUBSTRING_INDEX(resep_obat.alergi, '#', 1)) AS alergi from resep_obat where no_resep = ?",
                no_resep));
    ...
    public void tampildetailracikanobat() {
        try {
            ...
            String[] no, kodebarang, namabarang, kodesatuan, namajenis, industri, kategori, golongan, nobatch, nofaktur,
                    kadaluarsa;
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeDetailObatRacikan.addRow(new Object[] {
                                    ...
                                    list.path("Satuan").asText(), Double.parseDouble(list.path("HargaKelas1").asText()),
                                    Double.parseDouble(list.path("HargaBeli").asText()),
                                    list.path("Jenis").asText(), Double.parseDouble(list.path("Stok").asText()),
                                    Double.parseDouble(list.path("Kapasitas").asText()), "", 0, 0, 0,
                                    list.path("IndustriFarmasi").asText(), list.path("Kategori").asText(),
                                    list.path("Golongan").asText(), list.path("NoBatch").asText(),
                                    list.path("NoFaktur").asText(), list.path("Kadaluarsa").asText()
                            });
                        }
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeDetailObatRacikan.addRow(new Object[] {
                                    tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 0).toString(),
                                    list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), Double.parseDouble(list.path("HargaKelas2").asText()),
                                    Double.parseDouble(list.path("HargaBeli").asText()),
                                    list.path("Jenis").asText(), Double.parseDouble(list.path("Stok").asText()),
                                    Double.parseDouble(list.path("Kapasitas").asText()), "", 0, 0, 0,
                                    list.path("IndustriFarmasi").asText(), list.path("Kategori").asText(),
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeDetailObatRacikan.addRow(new Object[] {
                                    tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 0).toString(),
                                    list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), Double.parseDouble(list.path("HargaKelas3").asText()),
                                    Double.parseDouble(list.path("HargaBeli").asText()),
                                    list.path("Jenis").asText(), Double.parseDouble(list.path("Stok").asText()),
                                    Double.parseDouble(list.path("Kapasitas").asText()), "", 0, 0, 0,
                                    list.path("IndustriFarmasi").asText(), list.path("Kategori").asText(),
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeDetailObatRacikan.addRow(new Object[] {
                                    tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 0).toString(),
                                    list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), Double.parseDouble(list.path("HargaUtama").asText()),
                                    Double.parseDouble(list.path("HargaBeli").asText()),
                                    list.path("Jenis").asText(), Double.parseDouble(list.path("Stok").asText()),
                                    Double.parseDouble(list.path("Kapasitas").asText()), "", 0, 0, 0,
                                    list.path("IndustriFarmasi").asText(), list.path("Kategori").asText(),
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeDetailObatRacikan.addRow(new Object[] {
                                    tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 0).toString(),
                                    list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), Double.parseDouble(list.path("HargaVIP").asText()),
                                    Double.parseDouble(list.path("HargaBeli").asText()),
                                    list.path("Jenis").asText(), Double.parseDouble(list.path("Stok").asText()),
                                    Double.parseDouble(list.path("Kapasitas").asText()), "", 0, 0, 0,
                                    list.path("IndustriFarmasi").asText(), list.path("Kategori").asText(),
                        ...
                        for (JsonNode list : response) {
                            if (list.path("KodeBarang").asText().toLowerCase().contains(cari)
                                ...
                                tabModeDetailObatRacikan.addRow(new Object[] {
                                        ...
                                        list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                        list.path("Satuan").asText(),
                                        Double.parseDouble(list.path("HargaVIP").asText()),
                                        Double.parseDouble(list.path("HargaBeli").asText()),
                                        list.path("Jenis").asText(), Double.parseDouble(list.path("Stok").asText()),
                                        Double.parseDouble(list.path("Kapasitas").asText()), "", 0, 0, 0,
                                        list.path("IndustriFarmasi").asText(), list.path("Kategori").asText(),
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeDetailObatRacikan.addRow(new Object[] {
                                    tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 0).toString(),
                                    list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), Double.parseDouble(list.path("HargaVVIP").asText()),
                                    Double.parseDouble(list.path("HargaBeli").asText()),
                                    list.path("Jenis").asText(), Double.parseDouble(list.path("Stok").asText()),
                                    Double.parseDouble(list.path("Kapasitas").asText()), "", 0, 0, 0,
                                    list.path("IndustriFarmasi").asText(), list.path("Kategori").asText(),
                    ...
                    try {
                        ...
                        while (rsobat.next()) {
                            ...
                            if (rsobat.getDouble("jml") > sisacari) {
                                ...
                                tabMode.addRow(new Object[] {
                                        false, rsobat.getString("jml"), rsobat.getString("kode_brng"),
                                        rsobat.getString("nama_brng"),
                                        rsobat.getString("kode_sat"), rsobat.getString("letak_barang"),
                                        Valid.roundUp(hargacari, 100),
                                        rsobat.getString("nama"), 0, 0, sisacari, rsobat.getString("nama_industri"),
                ...
                if (rsobat.next()) {
                    ...
                    do {
                        tabModeObatRacikan.addRow(new Object[] {
                                rsobat.getString("no_racik"), rsobat.getString("nama_racik"),
                                rsobat.getString("kd_racik"),
                                    ...
                                    while (rs2.next()) {
                                        ...
                                        psbatch = koneksi.prepareStatement(
                                                "select data_batch.no_batch, data_batch.kode_brng, data_batch.tgl_beli, data_batch.tgl_kadaluarsa, data_batch.asal, data_batch.no_faktur, "
                                                        ...
                                                        "data_batch.h_beli,(data_batch.h_beli+(data_batch.h_beli*?)) as harga, gudangbarang.stok,data_batch."
                                                        + hppfarmasi
                                                        + " as dasar from data_batch inner join gudangbarang " +
                                                        "on data_batch.kode_brng=gudangbarang.kode_brng and data_batch.no_batch=gudangbarang.no_batch and data_batch.no_faktur=gudangbarang.no_faktur where "
                                                        +
                                                        "gudangbarang.stok>0 and data_batch.kode_brng=? and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa desc limit 1");
                                        try {
                                        ...
                                        if (rs2.getDouble("jml") > sisacari) {
                                            ...
                                            tabModeDetailObatRacikan.addRow(new Object[] {
                                                    ...
                                                    rs2.getString("jenis"), sisacari, rs2.getDouble("kapasitas"),
                                                    rs2.getString("kandungan"),
                                                    sisacari, 0, 0, rs2.getString("nama_industri"),
                                                    rs2.getString("kategori"),
                                                    rs2.getString("golongan"), no_batchcari, no_fakturcari,
                                                    tgl_kadaluarsacari
                                            });
                                        } else {
                                            tabModeDetailObatRacikan.addRow(new Object[] {
    ...
    private void simpanObatPCare(String noKunjungan, String racikan, String kdObat, String signa1, String signa2,
        ...
        try {
            ...
            requestJson = api.getRest().exchange(URL + "/obat/kunjungan", HttpMethod.POST, requestEntity, String.class)
                    .getBody();
            System.out.println(requestJson);
