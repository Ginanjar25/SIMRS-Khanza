...
public class DlgPembelian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Transaksi Pengadaan Obat, Alkes & BHP Medis ]::",
                    ...
                    if (Sequel.menyimpantf2("pembelian", "?,?,?,?,?,?,?,?,?,?,?", "No.Faktur", 11, new String[] {
                            ...
                            try {
                                if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                                    if (Sequel.menyimpantf2("detailbeli", "?,?,?,?,?,?,?,?,?,?,?,?",
                                            "Transaksi Pembelian", 12, new String[] {
                                                    NoFaktur.getText(),
                                        ...
                                        if (aktifkanbatch.equals("yes")) {
                                            Trackobat.catatRiwayat(tbDokter.getValueAt(i, 2).toString(),
                                                    Valid.SetAngka(tbDokter.getValueAt(i, 12).toString()), 0,
                                                    "Pengadaan", akses.getkode(), kdgudang.getText(), "Simpan",
                                                    tbDokter.getValueAt(i, 13).toString(), NoFaktur.getText(),
                                                    NoFaktur.getText() + " " + nmsup.getText());
                                            Sequel.menyimpan("gudangbarang",
                                                    ...
                                                    "kode_brng='" + tbDokter.getValueAt(i, 2).toString()
                                                            ...
                                                            + "' and no_batch='" + tbDokter.getValueAt(i, 13).toString()
                        ...
                        if (sukses == true) {
                            ...
                            if (Sequel.menyimpantf2("tampjurnal", "?,?,?,?", 4,
                                    new String[] { Pengadaan_Obat, "PEMBELIAN", "" + ttl, "0" }) == false) {
                                sukses = false;
                            }
                            if (ppn > 0) {
                                if (Sequel.menyimpantf2("tampjurnal", "?,?,?,?", 4,
                                        new String[] { PPN_Masukan, "PPN Masukan Obat", "" + ppn, "0" }) == false) {
                                    sukses = false;
                                }
                            }
                            if (Sequel.menyimpantf2("tampjurnal", "?,?,?,?", 4, new String[] { kode_akun_bayar,
                                    AkunBayar.getSelectedItem().toString(), "0", "" + (ttl + ppn) }) == false) {
                                sukses = false;
                            }
                            if (sukses == true) {
                                sukses = jur.simpanJurnal(NoFaktur.getText(), "U", "PEMBELIAN DI "
            ...
            try {
                ...
                while (rs.next()) {
                    iyembuilder.append("{\"SatuanBeli\":\"").append(rs.getString(6)).append("\",\"KodeBarang\":\"")
                            ...
                            .append("\",\"Harga\":\"").append(rs.getString(9)).append("\",\"Isi\":\"")
    ...
    private void tampil2() {
        try {
            ...
            double[] harga, jumlah, subtotal, diskon, besardiskon, jmltotal, jmlstok, hpp, isi, jmlbesar, ralan, kelas1,
            ...
            if (tbDokter.getValueAt(i, 5).toString().equals("true")) {
                Sequel.mengedit("databarang", "kode_brng=?",
                        ...
                        14, new String[] {
                                ...
                                tbDokter.getValueAt(i, 17).toString(),
                                tbDokter.getValueAt(i, 18).toString(), tbDokter.getValueAt(i, 19).toString(),
                                tbDokter.getValueAt(i, 20).toString(), tbDokter.getValueAt(i, 21).toString(),
                                tbDokter.getValueAt(i, 22).toString(), tbDokter.getValueAt(i, 23).toString(),
