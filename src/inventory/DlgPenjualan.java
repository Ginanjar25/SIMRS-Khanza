...
public class DlgPenjualan extends javax.swing.JDialog {
    ...
    private double ttl = 0, ttlhpp = 0, y = 0, z = 0, stokbarang = 0, bayar = 0, total = 0, ppn = 0, besarppn = 0,
            ppnobat = 0, besarppnobat = 0, tagihanppn = 0, ongkir = 0;
    ...
    private String verifikasi_penjualan_di_kasir = "", Penjualan_Obat = "", HPP_Obat_Jual_Bebas = "",
            Persediaan_Obat_Jual_Bebas = "", DEPOAKTIFOBAT = "",
            status = "Belum Dibayar", pilihanetiket = "", hppfarmasi = "", kode_akun_bayar = "",
            tampilkan_ppnobat_ralan = "", PPN_Keluaran = "", DEPOAKTIFOBAT = "", kd_bangsal = "";
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Transaksi Penjualan Obat, Alkes & BHP Medis ]::",
        ...
        Jenisjual.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Jual Bebas", "Karyawan", "Beli Luar",
    ...
    private void tbObatKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_tbObatKeyPressed
        if (tabMode.getRowCount() != 0) {
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                if (i == 10) {
                    try {
                        if (tbObat.getValueAt(tbObat.getSelectedRow(), 10).toString().equals("0")
                                || tbObat.getValueAt(tbObat.getSelectedRow(), 10).toString().equals("")
                                || tbObat.getValueAt(tbObat.getSelectedRow(), 10).toString().equals("0.0")
                                || tbObat.getValueAt(tbObat.getSelectedRow(), 10).toString().equals("0,0")) {
                    ...
                    try {
                        if (tbObat.getValueAt(tbObat.getSelectedRow(), 11).toString().equals("0")
                                || tbObat.getValueAt(tbObat.getSelectedRow(), 11).toString().equals("")
                                || tbObat.getValueAt(tbObat.getSelectedRow(), 11).toString().equals("0.0")
                                || tbObat.getValueAt(tbObat.getSelectedRow(), 11).toString().equals("0,0")) {
                        ...
                        public void windowClosed(WindowEvent e) {
                            if (aturan_pakai.getTable().getSelectedRow() != -1) {
                                if (TabRawat.getSelectedIndex() == 0) {
                                    tbObat.setValueAt(
                                            aturan_pakai.getTable()
                                                    .getValueAt(aturan_pakai.getTable().getSelectedRow(), 0).toString(),
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (aktifkanbatch.equals("yes")) {
            ...
            for (i = 0; i < jml; i++) {
                if ((Valid.SetAngka(tbObat.getValueAt(i, 0).toString()) > 0)
                        && (tbObat.getValueAt(i, 16).toString().trim().equals("")
                                || tbObat.getValueAt(i, 17).toString().trim().equals(""))) {
                    row++;
                }
            }
            ...
            for (i = 0; i < jml; i++) {
                if ((Valid.SetAngka(tbDetailObatRacikan.getValueAt(i, 8).toString()) > 0)
                        && (tbDetailObatRacikan.getValueAt(i, 18).toString().trim().equals("")
                                || tbDetailObatRacikan.getValueAt(i, 19).toString().trim().equals(""))) {
                    row++;
                }
            }
        }
        ...
        if (NoNota.getText().trim().equals("")) {
            ...
            reply = JOptionPane.showConfirmDialog(rootPane, "Eeiiiiiits, udah bener belum data yang mau disimpan..??",
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if (Sequel.menyimpantf2("penjualan", "?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Nota", 13, new String[] {
                        NoNota.getText(), Valid.SetTgl(Tgl.getSelectedItem() + ""), kdptg.getText(), kdmem.getText(),
                        nmmem.getText(),
                        catatan.getText(), Jenisjual.getSelectedItem().toString(), Double.toString(ongkir),
                        Double.toString(besarppnobat),
                        status, kdgudang.getText(), kode_akun_bayar,
                        AkunBayar.getSelectedItem().toString() }) == true) {
                    simpan();
                } else {
                    autoNomor();
                    if (Sequel.menyimpantf2("penjualan", "?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Nota", 13, new String[] {
                            NoNota.getText(), Valid.SetTgl(Tgl.getSelectedItem() + ""), kdptg.getText(),
                            kdmem.getText(), nmmem.getText(),
                            catatan.getText(), Jenisjual.getSelectedItem().toString(), Double.toString(ongkir),
                            Double.toString(besarppnobat),
                            status, kdgudang.getText(), kode_akun_bayar,
                            AkunBayar.getSelectedItem().toString() }) == true) {
                ...
                if (sukses == true) {
                    ...
                    for (int r = 0; r < tabMode.getRowCount(); r++) {
                        try {
                            if (Valid.SetAngka(tabMode.getValueAt(r, 0).toString()) > 0) {
                                tabMode.setValueAt(Double.parseDouble(tabMode.getValueAt(r, 14).toString())
                                        - Double.parseDouble(tabMode.getValueAt(r, 0).toString()), r, 14);
                            }
                        } catch (Exception e) {
                        }
                        ...
                        try {
                            if (Valid.SetAngka(tbDetailObatRacikan.getValueAt(r, 8).toString()) > 0) {
                                tbDetailObatRacikan.setValueAt(
                                        Double.parseDouble(tbDetailObatRacikan.getValueAt(r, 16).toString())
                    ...
                    try {
                        pilihanetiket = (String) JOptionPane.showInputDialog(null,
                                ...
                                JOptionPane.QUESTION_MESSAGE, null, new Object[] { "Cetak Aturan Pakai Model 1",
                                        "Cetak Aturan Pakai Model 2", "Cetak Aturan Pakai Model 3" },
                                ...
                                if (Sequel.cariInteger(
                                    ...
                                    Valid.MyReportqry("rptItemResepPenjualan2.jasper", "report",
                                            ...
                                            "select penjualan.nota_jual,penjualan.tgl_jual,metode_racik.nm_racik, " +
                                                    ...
                                                    +
                                                    "where obat_racikan_jual.nota_jual='" + NoNota.getText()
                                                    + "' and obat_racikan_jual.aturan_pakai<>''",
                                            param);
                                }
    ...
    private void BtnNotaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnNotaActionPerformed
        ...
        if (NoNota.getText().trim().equals("")) {
                ...
                try {
                    if (Valid.SetAngka(tabMode.getValueAt(i, 0).toString()) > 0) {
                        Sequel.menyimpan2("temporary",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", 38,
                                new String[] {
                                        "" + row, tabMode.getValueAt(i, 0).toString(),
                                        ...
                                        tabMode.getValueAt(i, 6).toString(), tabMode.getValueAt(i, 8).toString(),
            ...
            Valid.panggilUrl("billing/NotaApotek.php?nonota=" + NoNota.getText() + "&besarppn="
                    + (besarppn + besarppnobat) + "&ongkir=" + ongkir + "&bayar=" + Bayar.getText() + "&tanggal="
                    + Valid.SetTgl(Tgl.getSelectedItem() + "") + "&catatan=" + catatan.getText().replaceAll(" ", "_")
                    + "&petugas=" + nmptg.getText().replaceAll(" ", "_") + "&pasien="
                    + nmmem.getText().replaceAll(" ", "_") + "&norm=" + kdmem.getText().replaceAll(" ", "_")
                    + "&alamatip=" + akses.getalamatip() + "&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte="
    ...
    private void kdmemKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_kdmemKeyPressed
        switch (evt.getKeyCode()) {
            case KeyEvent.VK_PAGE_UP:
                Sequel.cariIsi("select pasien.nm_pasien from pasien where pasien.no_rkm_medis=?", nmmem,
                        kdmem.getText());
                Tgl.requestFocus();
                break;
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 1).equals("")
                && tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 2).equals("")
                && tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 3).equals("")
    ...
    private void tbDetailObatRacikanKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_tbDetailObatRacikanKeyPressed
        if (tabModeDetailRacikan.getRowCount() != 0) {
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                if (i == 13) {
                    try {
                        if (tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 13).toString()
                                .equals("0")
                                || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 13).toString()
                                        .equals("")
                                || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 13).toString()
                                        .equals("0.0")
                                || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 13).toString()
                    ...
                    try {
                        if (tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 14).toString()
                                .equals("0")
                                || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 14).toString()
                                        .equals("")
                                || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 14).toString()
                                        .equals("0.0")
                                || tbDetailObatRacikan.getValueAt(tbDetailObatRacikan.getSelectedRow(), 14).toString()
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select databarang.kode_brng, databarang.nama_brng,jenis.nama,gudangbarang.stok, " +
                            ...
                            " databarang.kelas3,databarang.utama,databarang.vip,databarang.vvip,databarang."
                            + hppfarmasi + " as dasar  " +
                            ...
                            (TCari.getText().trim().equals("") ? ""
                                    : "and (databarang.kode_brng like ? or databarang.nama_brng like ? or jenis.nama like ?)")
                            +
                ...
                if (Jenisjual.getSelectedItem().equals("Karyawan")) {
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                                ...
                                Valid.roundUp(rs.getDouble("karyawan"), 100), 0, 0, 0, 0, 0, 0, "", 0,
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                                "", rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("jualbebas"), 100), 0, 0, 0, 0, 0, 0, "", 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                                "", rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("beliluar"), 100), 0, 0, 0, 0, 0, 0, "", 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                                "", rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("ralan"), 100), 0, 0, 0, 0, 0, 0, "", 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                                "", rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("kelas1"), 100), 0, 0, 0, 0, 0, 0, "", 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                                "", rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("kelas2"), 100), 0, 0, 0, 0, 0, 0, "", 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                                "", rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("kelas3"), 100), 0, 0, 0, 0, 0, 0, "", 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                                "", rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("utama"), 100), 0, 0, 0, 0, 0, 0, "", 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                                "", rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("vip"), 100), 0, 0, 0, 0, 0, 0, "", 0, rs.getDouble("stok"),
                                rs.getDouble("dasar"), "", "", ""
                        });
                    }
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[] {
                                "", rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("vvip"), 100), 0, 0, 0, 0, 0, 0, "", 0, rs.getDouble("stok"),
                                rs.getDouble("dasar"), "", "", ""
                        });
                    }
                }
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select data_batch.kode_brng, databarang.nama_brng,jenis.nama, " +
                            ...
                            (TCari.getText().trim().equals("") ? ""
                                    : "and (data_batch.kode_brng like ? or databarang.nama_brng like ? or data_batch.no_batch like ? or data_batch.no_faktur like ? or jenis.nama like ?)")
                            +
                ...
                if (Jenisjual.getSelectedItem().equals("Karyawan")) {
                    while (rs.next()) {
                        tabMode.addRow(new Object[] { "", rs.getString("kode_brng"),
                                ...
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("karyawan"), 100), 0, 0, 0, 0, 0, 0, "", 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), rs.getString("no_batch"),
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[] { "", rs.getString("kode_brng"),
                                ...
                                rs.getString("kode_sat"),
                                Valid.roundUp(rs.getDouble("vip"), 100), 0, 0, 0, 0, 0, 0, "", 0, rs.getDouble("stok"),
                                rs.getDouble("dasar"), rs.getString("no_batch"), rs.getString("no_faktur"),
    ...
    private void tampil3() {
        try {
            ...
            double[] harga, hbeli, jumlah, kps, subtotal, diskon, besardiskon, totaljual, tambahan, embalase, tuslah,
                    stok;
                ...
                if (Jenisjual.getSelectedItem().equals("Karyawan")) {
                    while (rs.next()) {
                        tabModeDetailRacikan.addRow(new Object[] {
                                ...
                                rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                rs.getDouble("karyawan"), rs.getDouble("kapasitas"), "", 0, 0, 0, 0, 0, 0, 0, 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                } else if (Jenisjual.getSelectedItem().equals("Jual Bebas")) {
                    while (rs.next()) {
                        tabModeDetailRacikan.addRow(new Object[] {
                                ...
                                rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                rs.getDouble("jualbebas"), rs.getDouble("kapasitas"), "", 0, 0, 0, 0, 0, 0, 0, 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                } else if (Jenisjual.getSelectedItem().equals("Beli Luar")) {
                    while (rs.next()) {
                        tabModeDetailRacikan.addRow(new Object[] {
                                ...
                                rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                rs.getDouble("beliluar"), rs.getDouble("kapasitas"), "", 0, 0, 0, 0, 0, 0, 0, 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                } else if (Jenisjual.getSelectedItem().equals("Rawat Jalan")) {
                    while (rs.next()) {
                        tabModeDetailRacikan.addRow(new Object[] {
                                ...
                                rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                rs.getDouble("ralan"), rs.getDouble("kapasitas"), "", 0, 0, 0, 0, 0, 0, 0, 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                } else if (Jenisjual.getSelectedItem().equals("Kelas 1")) {
                    while (rs.next()) {
                        tabModeDetailRacikan.addRow(new Object[] {
                                ...
                                rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                rs.getDouble("kelas1"), rs.getDouble("kapasitas"), "", 0, 0, 0, 0, 0, 0, 0, 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                } else if (Jenisjual.getSelectedItem().equals("Kelas 2")) {
                    while (rs.next()) {
                        tabModeDetailRacikan.addRow(new Object[] {
                                ...
                                rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                rs.getDouble("kelas2"), rs.getDouble("kapasitas"), "", 0, 0, 0, 0, 0, 0, 0, 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                } else if (Jenisjual.getSelectedItem().equals("Kelas 3")) {
                    while (rs.next()) {
                        tabModeDetailRacikan.addRow(new Object[] {
                                ...
                                rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                rs.getDouble("kelas3"), rs.getDouble("kapasitas"), "", 0, 0, 0, 0, 0, 0, 0, 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                } else if (Jenisjual.getSelectedItem().equals("Utama/BPJS")) {
                    while (rs.next()) {
                        tabModeDetailRacikan.addRow(new Object[] {
                                ...
                                rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                rs.getDouble("utama"), rs.getDouble("kapasitas"), "", 0, 0, 0, 0, 0, 0, 0, 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                } else if (Jenisjual.getSelectedItem().equals("VIP")) {
                    while (rs.next()) {
                        tabModeDetailRacikan.addRow(new Object[] {
                                ...
                                rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                rs.getDouble("vip"), rs.getDouble("kapasitas"), "", 0, 0, 0, 0, 0, 0, 0, 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                } else if (Jenisjual.getSelectedItem().equals("VVIP")) {
                    while (rs.next()) {
                        tabModeDetailRacikan.addRow(new Object[] {
                                ...
                                rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("nama"),
                                rs.getString("kode_sat"),
                                rs.getDouble("vvip"), rs.getDouble("kapasitas"), "", 0, 0, 0, 0, 0, 0, 0, 0,
                                rs.getDouble("stok"), rs.getDouble("dasar"), "", "", ""
                        });
                    }
                }
                                ...
                                tbDetailObatRacikan.setValueAt(
                                        Valid.SetAngka8((Double.parseDouble(
                                                ...
                                                * Double.parseDouble(tbDetailObatRacikan
                                                        .getValueAt(tbDetailObatRacikan.getSelectedRow(), 7)
                                                        .toString()))
                                                / Double.parseDouble(tbDetailObatRacikan
                                                        .getValueAt(tbDetailObatRacikan.getSelectedRow(), 6)
                                                        .toString()),
                                                1),
                                ...
                                tbDetailObatRacikan
                                        .setValueAt(
                                                Double.parseDouble(tbDetailObatRacikan.getValueAt(row, 9).toString())
                                                        - Double.parseDouble(
                                                                tbDetailObatRacikan.getValueAt(row, 11).toString())
                                                        + Double.parseDouble(
                                                                tbDetailObatRacikan.getValueAt(row, 12).toString())
                                                        + Double.parseDouble(
                                                                tbDetailObatRacikan.getValueAt(row, 13).toString())
                                                        + Double.parseDouble(
    ...
    private void simpan() {
        ...
        for (i = 0; i < tbObatRacikan.getRowCount(); i++) {
            if (Valid.SetAngka(tbObatRacikan.getValueAt(i, 4).toString()) > 0) {
                if (Sequel.menyimpantf2("obat_racikan_jual", "?,?,?,?,?,?,?", "obat racikan jual", 7, new String[] {
                        NoNota.getText(), tbObatRacikan.getValueAt(i, 0).toString(),
                        tbObatRacikan.getValueAt(i, 1).toString(),
                ...
                if (Valid.SetAngka(tbDetailObatRacikan.getValueAt(i, 8).toString()) > 0) {
                    if (Sequel.menyimpantf2("detailjual", "'" + NoNota.getText() + "','" +
                        ...
                        if (Sequel.menyimpantf2("detail_obat_racikan_jual", "?,?,?", "Detail Racikan", 3, new String[] {
                                NoNota.getText(), tbDetailObatRacikan.getValueAt(i, 0).toString(),
                                tbDetailObatRacikan.getValueAt(i, 1).toString()
                        }) == false) {
                            sukses = false;
                        }
        ...
        if (verifikasi_penjualan_di_kasir.equals("No")) {
            if (sukses == true) {
                ...
                if (Sequel.menyimpantf2("tampjurnal", "'" + kode_akun_bayar + "','"
                        + AkunBayar.getSelectedItem().toString() + "','" + (ttl + ongkir + besarppnobat) + "','0'",
                        "Rekening") == false) {
                    sukses = false;
                }
                if (Sequel.menyimpantf2("tampjurnal",
                ...
                if (sukses == true) {
                    sukses = Sequel.menyimpantf2("tagihan_sadewa", "'" + NoNota.getText() + "','" + kdmem.getText()
                            ...
                            + Valid.SetTgl(Tgl.getSelectedItem() + "") +
                            "',' ',CURTIME()),'Pelunasan','" + Double.toString(ttl + ongkir + besarppnobat) + "','"
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyembuilder.append("{\"NamaAkun\":\"" + rs.getString(1).replaceAll("\"", "") + "\",\"KodeRek\":\""
