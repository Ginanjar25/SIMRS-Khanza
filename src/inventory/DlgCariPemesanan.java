...
public class DlgCariPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Cari Penerimaan Obat, Alkes & BHP Medis ]::",
        ...
        Status.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "Semua", "Sudah Dibayar", "Belum Dibayar", "Belum Lunas", "Titip Faktur" }));
        ...
        FormPhoto.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), " Photo Faktur : ",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
                    ...
                    if (tabMode.getRowCount() == 0) {
                        ...
                        for (i = 0; i < row; i++) {
                            Sequel.menyimpan("temporary", "'" + i + "','" +
                                    ...
                                    + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"
                                    + akses.getalamatip() + "'", "Transaksi Penerimaan");
                        }
                        i++;
                        Sequel.menyimpan("temporary", "'" + i
                                + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"
                        ...
                        Valid.MyReportqry("rptPemesanan.jasper", "report", "::[ Transaksi Penerimaan Barang ]::",
    ...
    private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ppHapusActionPerformed
        if (tbDokter.getSelectedRow() != -1) {
            if (!tbDokter.getValueAt(tbDokter.getSelectedRow(), 10).toString().trim().equals("")) {
                ...
                int reply = JOptionPane.showConfirmDialog(rootPane, "Eeiiiiiits, yakin mau dihapus...??", "Konfirmasi",
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                try {
                                    ...
                                    while (rs2.next()) {
                                        if (aktifkanbatch.equals("yes")) {
                                            Trackobat.catatRiwayat(rs2.getString("kode_brng"), 0,
                                                    rs2.getDouble("jumlah2"), "Penerimaan", akses.getkode(),
                                                    rs.getString("kd_bangsal"), "Hapus", rs2.getString("no_batch"),
                                                    rs2.getString("no_faktur"),
                                                    rs2.getString("no_faktur") + " " + rs.getString("no_order"));
                                            Sequel.menyimpan("gudangbarang", "'" + rs2.getString("kode_brng") + "','"
                                                    + rs.getString("kd_bangsal") + "','-" + rs2.getString("jumlah2")
                                                    + "','" + rs2.getString("no_batch") + "','"
                                                    + rs2.getString("no_faktur") + "'",
                                                    "stok=stok-'" + rs2.getString("jumlah2") + "'",
                                ...
                                if (sukses == true) {
                                    ...
                                    if (Sequel.menyimpantf2("tampjurnal", "?,?,?,?", "Rekening", 4,
                                            new String[] {
                                                    Sequel.cariIsi("select set_akun.Pemesanan_Obat from set_akun"),
                                                    "PERSEDIAAN BARANG", "0", rs.getString("total") }) == false) {
                                        sukses = false;
                                    }
                                    if (rs.getDouble("ppn") > 0) {
                                        if (Sequel.menyimpantf2("tampjurnal", "?,?,?,?", "Rekening", 4,
                                                new String[] {
                                                        Sequel.cariIsi("select set_akun.PPN_Masukan from set_akun"),
                                                        "PPN Masukan Obat", "0", rs.getString("ppn") }) == false) {
                                            sukses = false;
                                        }
                                    }
                                    if (Sequel
                                            .menyimpantf2("tampjurnal", "?,?,?,?", "Rekening", 4,
                                                    new String[] { Sequel.cariIsi(
                                                            "select set_akun.Kontra_Pemesanan_Obat from set_akun"),
                                                            "HUTANG USAHA", rs.getString("tagihan"), "0" }) == false) {
                                        sukses = false;
                                    }
                                    if (sukses == true) {
                                        sukses = jur.simpanJurnal(rs.getString("no_faktur"), "U",
                                                "BATAL TRANSAKSI PENERIMAAN BARANG DI " + Sequel.cariIsi(
                                                        "select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal=?",
                                                        rs.getString("kd_bangsal")).toUpperCase() + ", OLEH "
                                                        + akses.getkode());
                                    }
                                }

                                if (sukses == true) {
                                    sukses = Sequel.queryu2tf("delete from pemesanan where no_faktur=?", 1,
                                            new String[] {
    ...
    private void btnAmbilPhotoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAmbilPhotoActionPerformed
        if (tbDokter.getSelectedRow() != -1) {
            if (!tbDokter.getValueAt(tbDokter.getSelectedRow(), 10).toString().trim().equals("")) {
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Sequel.meghapus("bukti_pemesanan", "no_faktur",
                        tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString());
                Sequel.menyimpan2("bukti_pemesanan", "?,''", 1,
                        new String[] { tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString() });
                Valid.panggilUrl("penerimaanapotek/login.php?act=login&usere=" + koneksiDB.USERHYBRIDWEB()
                        + "&passwordte=" + koneksiDB.PASHYBRIDWEB() + "&nofaktur="
                        + tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString());
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    ...
    private void tampil() {
        ...
        try {
            String tanggal = "", datanofaktur = "", datasuplier = "", datapetugas = "", datajenis = "", databarang = "",
                    dataindustri = "", datacari = "", statusbayar = "";
            ...
            if (!TCari.getText().trim().equals("")) {
                datacari = " and (pemesanan.no_faktur like '%" + TCari.getText()
                        ...
                        + TCari.getText() + "%' or " +
                        " petugas.nama like '%" + TCari.getText() + "%' or bangsal.nm_bangsal like '%" + TCari.getText()
                        + "%' or detailpesan.kode_brng like '%" + TCari.getText() + "%' or databarang.nama_brng like '%"
                        + TCari.getText() + "%' or detailpesan.kode_sat like '%" + TCari.getText() + "%' or " +
            ...
            ps = koneksi.prepareStatement(
                    "select pemesanan.tgl_pesan,pemesanan.no_faktur,pemesanan.kode_suplier,datasuplier.nama_suplier,pemesanan.nip,petugas.nama,bangsal.nm_bangsal,"
                            ...
                            +
                            "where " + tanggal + datanofaktur + datasuplier + datapetugas + datajenis + databarang
                            + dataindustri + statusbayar + datacari +
                ...
                while (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select detailpesan.kode_brng,databarang.nama_brng,detailpesan.kode_sat,kodesatuan.satuan,detailpesan.jumlah,detailpesan.h_pesan, "
                                    ...
                                    + (nmjenis.getText().trim().equals("") ? "" : "and databarang.kdjns=? ")
                                    + (nmbar.getText().trim().equals("") ? "" : "and detailpesan.kode_brng=? ") +
                                    (NmIF.getText().trim().equals("") ? "" : "and databarang.kode_industri=? ")
                                    + (TCari.getText().trim().equals("") ? ""
                                            : "and (detailpesan.kode_brng like ? or " +
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new Object[] {
                                    no + ". Batch " + rs2.getString("no_batch"), "Exp : " + rs2.getString("kadaluarsa"),
            ...
            try {
                ...
                while (rs.next()) {
                    htmlContent.append(
                            "<tr class='isi'>").append(
                                    "<td valign='top' align='center'>")
                            .append(rs.getString("no_faktur")).append("</td>").append(
                                    "<td valign='top' align='center'>")
                            .append(rs.getString("tgl_faktur")).append("</td>").append(
                                    "<td valign='top' align='center'>")
                            .append(rs.getString("tgl_pesan")).append("</td>").append(
                                    "<td valign='top' align='center'>")
                            .append(rs.getString("tgl_tempo")).append("</td>").append(
                                    "<td valign='top' align='center'>")
                            .append(rs.getString("status")).append("</td>").append(
                                    "<td valign='top' align='left'>")
                            .append(rs.getString("kode_suplier")).append(", ").append(rs.getString("nama_suplier"))
                            .append("</td>").append(
                                    "<td valign='top' align='left'>")
                            .append(rs.getString("nip")).append(", ").append(rs.getString("nama")).append("</td>")
                            .append(
                                    "<td valign='top' align='left' colspan='8'>")
                            .append("Pengadaan di ").append(rs.getString("nm_bangsal")).append(" :").append("</td>")
                            .append(
                                    "<td valign='top' align='right'>")
                            .append(rs.getString("total2")).append("</td>").append(
                                    "<td valign='top' align='right'>")
                            .append(rs.getString("meterai")).append("</td>").append(
                                    "<td valign='top' align='right'>")
                            .append(rs.getString("ppn")).append("</td>").append(
                                    "<td valign='top' align='right'>")
                            .append(rs.getString("tagihan")).append("</td>").append(
                                    "</tr>");
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            htmlContent.append(
                                    ...
                                    .append(no).append(". No.Batch : ").append(rs2.getString("no_batch"))
                                    .append("</td>").append(
                                            "<td valign='top' align='left' colspan='2'>Exp : ")
                                    .append(rs2.getString("kadaluarsa")).append("</td>").append(
                                            "<td valign='top' align='left' colspan='2'>I.F. : ")
                                    .append(rs2.getString("nama_industri")).append("</td>").append(
                                            "<td valign='top' align='left'>")
                                    .append(rs2.getString("kode_brng")).append(", ").append(rs2.getString("nama_brng"))
                                    .append("</td>").append(
                                            "<td valign='top' align='center'>")
                                    .append(rs2.getString("satuan")).append("</td>").append(
                                            "<td valign='top' align='center'>")
                                    .append(rs2.getString("jumlah")).append("</td>").append(
                                            "<td valign='top' align='right'>")
                                    .append(rs2.getString("h_pesan")).append("</td>").append(
                                            "<td valign='top' align='right'>")
                                    .append(rs2.getString("subtotal")).append("</td>").append(
                                            "<td valign='top' align='right'>")
                                    .append(rs2.getString("dis")).append("</td>").append(
                                            "<td valign='top' align='right'>")
                                    .append(rs2.getString("besardis")).append("</td>").append(
                                            "<td valign='top' align='right'>")
                                    .append(rs2.getString("total")).append("</td>").append(
                                            "<td valign='top' align='center'>&nbsp;</td>")
                                    .append(
                                            "<td valign='top' align='center'>&nbsp;</td>")
                                    .append(
