...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private double h_belicari = 0, hargacari = 0, sisacari = 0, y = 0, kenaikan = 0, stokbarang = 0, ttl = 0,
            ppnobat = 0, ttlhpp, ttljual;
    ...
    private String signa1 = "1", signa2 = "1", nokunjungan = "", kdObatSK = "", requestJson = "", URL = "", otorisasi,
            ...
            aktifkanbatch = "no", kodedokter = "",
            namadokter = "", noresep = "", bangsal = "", hppfarmasi = "", VALIDASIULANGBERIOBAT = "",
            DEPOAKTIFOBAT = "", utc = "", no_resep = "";
    ...
    private void initComponents() {
        ...
        Jeniskelas.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "Rawat Jalan", "Beli Luar", "Karyawan", "Utama/BPJS" }));
                                            ...
                                            ttljual = ttljual + Math.round(Double
                                                    ...
                                                    + (Double.parseDouble(tbObat.getValueAt(i, 6).toString()) *
                                                            (Double.parseDouble(tbObat.getValueAt(i, 1).toString())
                                                                    / carikapasitas.getDouble(1))));
                                            ttlhpp = ttlhpp + Math
                                                    .round(Double.parseDouble(tbObat.getValueAt(i, 13).toString()) *
                                                            (Double.parseDouble(tbObat.getValueAt(i, 1).toString())
                                                                    / carikapasitas.getDouble(1)));
                    ...
                    if (sukses == true) {
                        ...
                        if (ttljual > 0) {
                            if (Sequel.menyimpantf2("tampjurnal",
                                    "'" + akunobatralan.getSuspen_Piutang_Obat_Ralan()
                                            + "','Suspen Piutang Obat Ralan','" + ttljual + "','0'",
                                    "Rekening") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf2(
                                    "tampjurnal", "'" + akunobatralan.getObat_Ralan()
                                            + "','Pendapatan Obat Rawat Jalan','0','" + ttljual + "'",
                                    "Rekening") == false) {
                                sukses = false;
                            }
                        }
                        if (ttlhpp > 0) {
                            if (Sequel.menyimpantf2("tampjurnal",
                                    "'" + akunobatralan.getHPP_Obat_Rawat_Jalan()
                                            + "','HPP Persediaan Obat Rawat Jalan','" + ttlhpp + "','0'",
                                    "Rekening") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf2("tampjurnal",
                                    "'" + akunobatralan.getPersediaan_Obat_Rawat_Jalan()
                                            + "','Persediaan Obat Rawat Jalan','0','" + ttlhpp + "'",
                                    "Rekening") == false) {
                                sukses = false;
                            }
                        }
                        if (sukses == true) {
                            if ((ttljual > 0) || (ttlhpp > 0)) {
                                sukses = jur.simpanJurnal(TNoRw.getText(), "U",
                                        "PEMBERIAN OBAT RAWAT JALAN PASIEN " + TNoRM.getText() + " " + TPasien.getText()
                                                + ", DIPOSTING OLEH " + akses.getkode());
                            }
                        }
                    }
                            ...
                            if (!ResepObat.isVisible()) {
                                ...
                                if (!namadokter.equals("")) {
                                    ResepObat.setNoRm(TNoRw.getText(), DTPTgl.getDate(), DTPTgl.getDate(),
                                            ...
                                            cmbDtk.getSelectedItem().toString(), kodedokter, namadokter, "ralan");
                                } else {
                                    ResepObat.setNoRm(TNoRw.getText(), DTPTgl.getDate(), DTPTgl.getDate(),
                                            cmbJam.getSelectedItem().toString(), cmbMnt.getSelectedItem().toString(),
        ...
        if (ChkNoResep.isSelected() == true) {
            ...
            if (!namadokter.equals("")) {
                resep.setNoRm(TNoRw.getText(), DTPTgl.getDate(), DTPTgl.getDate(), cmbJam.getSelectedItem().toString(),
                        cmbMnt.getSelectedItem().toString(), cmbDtk.getSelectedItem().toString(), kodedokter,
                        namadokter, "ralan");
            } else {
                resep.setNoRm(TNoRw.getText(), DTPTgl.getDate(), DTPTgl.getDate(), cmbJam.getSelectedItem().toString(),
                        cmbMnt.getSelectedItem().toString(), cmbDtk.getSelectedItem().toString(), "ralan");
                    ...
                    try {
                        ...
                        while (rsobat.next()) {
                            iyembuilder.append("{\"KodeBarang\":\"").append(rsobat.getString("kode_brng"))
                                    ...
                                    .append(rsobat.getDouble("dasar")).append("\",\"Stok\":\"")
                    ...
                    try {
                        ...
                        while (rsobat.next()) {
                            iyembuilder.append("{\"KodeBarang\":\"").append(rsobat.getString("kode_brng"))
                                    ...
                                    .append("\",\"HargaRalan\":\"")
                                    .append(Valid.roundUp(rsobat.getDouble("ralan"), 100))
                                    .append("\",\"HargaBeliLuar\":\"")
    ...
    private void tampilcacheberiobat() {
        try {
            ...
            String[] kodebarang, namabarang, kodesatuan, letakbarang, namajenis, aturan, industri, kategori, golongan,
            ...
            for (i = 0; i < z; i++) {
                tabModeobat.addRow(new Object[] {
                        pilih[i], jumlah[i], kodebarang[i], namabarang[i], kodesatuan[i], letakbarang[i], harga[i],
                        namajenis[i],
                        eb[i], ts[i], stok[i], aturan[i], industri[i], beli[i], kategori[i], golongan[i], nobatch[i],
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeobat.addRow(new Object[] {
                                    ...
                                    Double.parseDouble(list.path("HargaBeli").asText()), list.path("Kategori").asText(),
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeobat.addRow(new Object[] {
                                    false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                    Double.parseDouble(list.path("HargaRalan").asText()), list.path("Jenis").asText(),
                        ...
                        for (JsonNode list : response) {
                            if (list.path("KodeBarang").asText().toLowerCase().contains(cari)
                                ...
                                tabModeobat.addRow(new Object[] {
                                        false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                        list.path("Satuan").asText(), list.path("Kandungan").asText(),
                                        Double.parseDouble(list.path("HargaRalan").asText()),
                                        list.path("Jenis").asText(), 0, 0,
                                        Double.parseDouble(list.path("Stok").asText()), "",
                                        list.path("IndustriFarmasi").asText(),
                                        Double.parseDouble(list.path("HargaBeli").asText()),
            ...
            if (kenaikan > 0) {
                        ...
                        while (rsobat.next()) {
                            ...
                            if (rsobat.getDouble("jml") > sisacari) {
                                ...
                                tabModeobat.addRow(new Object[] {
                                        ...
                                        h_belicari, rsobat.getString("kategori"), rsobat.getString("golongan"),
                ...
                if (aktifkanbatch.equals("yes")) {
                    ...
                    psobat = koneksi.prepareStatement(
                            "select databarang.kode_brng, databarang.nama_brng,jenis.nama,databarang.kode_sat,databarang.karyawan,databarang.ralan,"
                                    +
                                    "databarang.beliluar,databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,resep_dokter.jml,databarang."
                                    + hppfarmasi + " as dasar, " +
                                    "resep_dokter.aturan_pakai,kategori_barang.nama as kategori,golongan_barang.nama as golongan "
                                    +
                                    "from databarang inner join jenis on databarang.kdjns=jenis.kdjns " +
    ...
    public void setNoRm(String norwt, String norm, String nama, String tanggal, String jam) {
        ...
        TCaraBayar.setText(Sequel.cariIsi(
                ...
                norwt));
        TKamar.setText(Sequel.cariIsi(
                "SELECT poliklinik.nm_poli FROM reg_periksa INNER JOIN poliklinik ON poliklinik.kd_poli = reg_periksa.kd_poli WHERE reg_periksa.no_rawat = ?",
                norwt));
        TCari.requestFocus();
    }
    ...
    private void tampildetailracikanobat() {
        try {
            ...
            String[] kodebarang, namabarang, kodesatuan, namajenis, industri, kategori, golongan, no, nobatch, nofaktur,
                    kadaluarsa;
            z = 0;
            for (i = 0; i < tbDetailObatRacikan.getRowCount(); i++) {
                if (Valid.SetAngka(tbDetailObatRacikan.getValueAt(i, 10).toString()) > 0) {
                    ...
                    if (TCari.getText().trim().equals("")) {
                        for (JsonNode list : response) {
                            tabModeDetailObatRacikan.addRow(new Object[] {
                                    tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(), 0).toString(),
                                    list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                    list.path("Satuan").asText(), Double.parseDouble(list.path("HargaRalan").asText()),
                                    Double.parseDouble(list.path("HargaBeli").asText()),
                                    list.path("Jenis").asText(), Double.parseDouble(list.path("Stok").asText()),
                                    Double.parseDouble(list.path("Kapasitas").asText()), "", 0, 0, 0,
                                    list.path("IndustriFarmasi").asText(), list.path("Kategori").asText(),
    ...
    // String validResep = "";
    // validResep = Sequel.cariIsi("SELECT CONCAT(resep_obat.tgl_perawatan, ' ',
    // resep_obat.jam) AS valid_resep FROM resep_obat WHERE resep_obat.no_resep =
    // ?", noresep);
    //
