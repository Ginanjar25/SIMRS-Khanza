...
public final class BPJSCekReferensiPenyakit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Pencarian Data Referensi Diagnosa VClaim ]::",
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (int r = 0; r < row; r++) {
                Sequel.menyimpan("temporary", "'" + r + "','" +
                        ...
                        + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"
                        + akses.getalamatip() + "'", "Rekap Harian Pengadaan Ipsrs");
            }
            ...
            // param.put("peserta","No.Peserta : "+NoKartu.getText()+" Nama Peserta :
            // "+NamaPasien.getText());
            param.put("kontakrs", akses.getkontakrs());
            param.put("emailrs", akses.getemailrs());
            param.put("logo", Sequel.cariGambar("select setting.logo from setting"));
            Valid.MyReportqry("rptCariBPJSReferensiDiagnosa.jasper", "report", "[ Pencarian Referensi Diagnosa ]",
    ...
    private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_BtnCariKeyPressed
        ...
        if(tabMode.getRowCount()!=0){ 
             if(evt.getKeyCode()= =K ey Event.VK_SPACE){
                 dispose();   
    ...
    */
    ...
    public void tampil(String diagnosa) {
	    ...
	    utc=String.valueOf(api.GetUTCdatetimeAsString());
            ...
            hea d ers.add("X-Signature",api.getHmac(utc));
                   headers.add("user_k ey",k
            requestEntity = new HttpEn tity(headers);
            ...
            if(nameNode.path("code").asText().equals("200")){
                ...
                if(response.path("diagnosa").isArray()){ 
                     i=1;
                     for(JsonNode list:response.path("di agnosa")){
                          tabMode.addRow(new Object[]{
                             i+".",lis t .path("kode").asText(),lis t.path("nama").asText().contains("-") ? list.path("nama").asText().split("-", 2)[1].trim() : list.path("nama").asText()
                        }); 
            ...
            if(ex.toString().contains("UnknownHostException")){
                JOptionPane.showMessageDialog( r ootPane,"Koneksi ke server BPJS terputus...!");
            }  
        } 
    }   
