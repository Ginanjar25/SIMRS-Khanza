 ...
 * @author dosen
 */
public final class DlgCariKamar extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariKamar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);
        tabMode=new DefaultTableModel(null,new String[]{"P","Nomer Bed","Kode Kamar","Nama Kamar","Kelas","Tarif Kamar","Status Kamar"}){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariKamar dialog = new DlgCariKamar(new javax.swing.JFrame(), true);
