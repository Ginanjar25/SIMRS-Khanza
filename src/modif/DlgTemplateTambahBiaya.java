 ...
 * @author dosen
 */
public class DlgTemplateTambahBiaya extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgTemplateTambahBiaya(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Tambahan Biaya","Nominal"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Template Tambah Biaya ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel4.setText("Tambahan Biaya :");
        ...
        Nama.setBounds(110, 10, 220, 23);

        jLabel5.setText("Biaya :");
        jLabel5.setName("jLabel5"); // NOI18N
        panelGlass7.add(jLabel5);
        jLabel5.setBounds(330, 10, 40, 23);
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Template Tambah Biaya ]::");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nama.getText().trim().equals("")){
            Valid.textKosong(Nama,"Template Tambah Biaya");
        }else{
            Sequel.menyimpan("template_tambahan_biaya","NULL,'"+Nama.getText()+"','"+Biaya.getText()+"'","Template Tambah Biaya");
            tampil();
            emptTeks();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTemplateTambahBiaya dialog = new DlgTemplateTambahBiaya(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from template_tambahan_biaya where nama like ? ");
            try {
    ...
    private void getData() {
        if(tbkecamatan.getSelectedRow()!= -1){
            ...
            Biaya.setText(tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),2).toString());
        }
    }
