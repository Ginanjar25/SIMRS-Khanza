 ...
 * @author dosen
 */
public final class RMCariRiwayatBookingOperasi extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMCariRiwayatBookingOperasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabModePemeriksaan = new DefaultTableModel(null, new Object[]{
            "NO RM", "NAMA PASIEN","TANGGAL","JAM MULAI", "JAM SELESAI", "DIAGNOSA", "NAMA OPERASI", "KODE OPERATOR", "NAMA OPERATOR"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariRiwayatBookingOperasi dialog = new RMCariRiwayatBookingOperasi(new javax.swing.JFrame(), true);
        ...
        Valid.tabelKosong(tabModePemeriksaan);
         try{        
            ps4=koneksi.prepareStatement(
                ...
                "where jadwal_operasi.no_rkm_medis LIKE ? ");
            try {
                ps4.setString(1,"%"+TCari.getText().trim()+"%");
                rs=ps4.executeQuery();  
                while(rs.next()){                    
                    tabModePemeriksaan.addRow(new String[]{
