...
public final class RMRiwayatRadiologi extends javax.swing.JDialog {    
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-06-2026 09:55:57" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Riwayat/Pemeriksaan Radiologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void BtnPasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPasienKeyPressed
    ...
    */
        ...
        try{
            ...
            try{
                ...
                while(rs.next()){                                         
                    ...
                    menampilkanBerkasradiologi(rs.getString("no_rawat"));
    ...
    private void menampilkanBerkasradiologi(String norawat) {
        try {
            if(1==1){                
                try{
                    rs2=koneksi.prepareStatement(
                        "select gambar_radiologi.tgl_periksa,gambar_radiologi.jam,gambar_radiologi.lokasi_gambar from gambar_radiologi where gambar_radiologi.no_rawat='"+norawat+"' order by gambar_radiologi.tgl_periksa,gambar_radiologi.jam").executeQuery();
                    if(rs2.next()){
                        urut++;
                        htmlContent.append(
                            "<tr class='isi'>").append( 
                        ...
                        htmlContent.append(
                          "<tr class='isi'>").append( 
                            "<td valign='top' width='2%'></td>").append(        
                            "<td valign='top' width='18%'>Berkas Radiologi</td>").append(
                            "<td valign='top' width='1%' align='center'>:</td>").append(
                            "<td valign='top' width='79%'>").append(
                              "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>").append(
                                 "<tr align='center'>").append(
                                    ...
                                    "<td valign='top' width='96%' bgcolor='#FFFAF8'>Berkas Radiologi</td>").append(
                                 "</tr>"
                        );
                        w=1;
                        do{
                            String url = getUrlRadiologi(rs2.getString("lokasi_gambar"));
                            if(rs2.getString("lokasi_gambar").toLowerCase().contains(".jpg")||rs2.getString("lokasi_gambar").toLowerCase().contains(".jpeg")){
                                htmlContent.append("<tr>")
                                           .append("<td valign='top' align='center'>").append(w).append("</td>")                                           
                                           .append("<td valign='top' align='center'><a href='").append(url).append("'>")
                                           .append("<img alt='Gambar Radiologi' src='").append(url).append("' width='900' />")
                                           .append("</a></td>")
                                           .append("</tr>");
                            } else {
                                htmlContent.append("<tr>")
                                        ...
                                        .append("<embed src='").append(url)
                                        .append("' width='450' height='600' type='application/pdf' />")
                                        .append("</td>")
                                        .append("</tr>");
                            }
                            w++;
