 ...
 * @author windiarto
 */
public final class RMRiwayatBerkasDigital extends javax.swing.JDialog {    
     ...
     * @param parent
     * @param modal */
    public RMRiwayatBerkasDigital(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-06-2026 11:23:24" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Riwayat/Berkas Digital ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMRiwayatBerkasDigital dialog = new RMRiwayatBerkasDigital(new javax.swing.JFrame(), true);
        ...
        try{
            ...
            if(R1.isSelected()==true){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_reg,reg_periksa.no_rawat,DATE_FORMAT(reg_periksa.tgl_registrasi, '%d-%m-%Y') AS tgl_registrasi,reg_periksa.jam_reg,"+
            ...
            if(1==1){                
                try{
                    rs2=koneksi.prepareStatement(
                        ...
                        "where berkas_digital_perawatan.no_rawat='"+norawat+"' and berkas_digital_perawatan.kode in ('005','013','006','014','009')").executeQuery();
                    if(rs2.next()){
                        urut++; 
                        htmlContent.append(
                            "<tr class='isi'>").append( 
                        ...
                        htmlContent.append(
                          "<tr class='isi'>").append( 
                            "<td valign='top' width='2%'></td>").append(        
                            "<td valign='top' width='10%'>Berkas Digital Perawatan</td>").append(
                            "<td valign='top' width='1%' align='center'>:</td>").append(
                            "<td valign='top' width='87%'>").append(
                        ...
                        do{
                            ...
                            String url = getUrlBerkas(rs2.getString("lokasi_file")); 
                            String ext = rs2.getString("lokasi_file").toLowerCase();                            
                            htmlContent.append("<tr>")
                                       .append("<td valign='top' align='center'>").append(w).append("</td>")
                                       .append("<td valign='top' align='center'>");
                            if(ext.endsWith(".jpg") || ext.endsWith(".jpeg") || ext.endsWith(".jpeg")|| ext.endsWith(".png")){
                                htmlContent.append("<b style='font-size: 15px;'>").append(nama).append("</b> ")
                                           .append("<b><span style='font-size: 12px; color: gray;'> Tgl : ")
                                           .append(rs.getString("tgl_registrasi"))
                                           .append("</span></b><br>")
                                           .append("<a href='").append(url).append("'>")
                                           .append("<img alt='Berkas Digital' src='").append(url).append("' width='900'/>")
                                           .append("</a>"); 
                            }else if (ext.endsWith(".pdf")) {
                                String nodeJsUrl = "http://192.168.106.3:8088/preview?file=" + url;
                                htmlContent.append("<b style='font-size: 15px;'>").append(nama).append("</b> ")
                                           .append("<b><span style='font-size: 12px; color: gray;'> Tgl : ")
                                           .append(rs.getString("tgl_registrasi"))
                                           .append("</span></b><br>")
                                           .append("<a href='").append(url).append("'>")
                                           .append("<img alt='Preview PDF' src='").append(nodeJsUrl).append("' width='900' />")
                                           .append("</a>"); 
                            }
    ...
    private String getUrlBerkas(String lokasi) {
        return "http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB()
                + "/" + koneksiDB.HYBRIDWEB() + "/berkasrawat/" + lokasi;
    }
