...
public final class DlgKunjunganRanap extends javax.swing.JDialog {
    ...
    public DlgKunjunganRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode2=new DefaultTableModel(null,new String[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Kode","Diagnosa","Ruang","Stts.Pulang","Tgl.Masuk","Tgl.Keluar","DPJP"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
                    ...
                    if(!tbBangsal.getValueAt(r,0).toString().contains(">>")){
                        try {
                            Sequel.menyimpan("temporary","'"+r+"','"+
                                        ...
                                        tabMode2.getValueAt(r,13).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Rekap Nota Pembayaran");
                        } catch (Exception e) {
                        }   
                    }                    
                }
