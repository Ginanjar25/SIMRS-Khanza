...
public final class DlgKunjunganRanap extends javax.swing.JDialog {
    ...
    public DlgKunjunganRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[] { "No.", "Lama", "Baru", "Nama Pasien", "L", "P", "Alamat",
                "Kode", "Diagnosa", "Ruang", "Stts.Pulang", "Tgl.Masuk", "Tgl.Keluar", "DPJP" }) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Data Kunjungan Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (TabRawat.getSelectedIndex() == 0) {
            if (tabMode.getRowCount() == 0) {
                ...
                Valid.MyReportqry("rptKunjunganRanap.jasper", "report", "::[ Laporan Kunjungan Rawat Inap ]::",
    ...
    private void kdkamarKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_kdkamarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            Sequel.cariIsi("select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal=?", nmkamar,
                    kdkamar.getText());
            ...
            kelurahan.addWindowListener(new WindowListener() {
                ...
                public void windowClosed(WindowEvent e) {
                    if (kelurahan.getTable().getSelectedRow() != -1) {
                        nmkelurahan.setText(
                                kelurahan.getTable().getValueAt(kelurahan.getTable().getSelectedRow(), 0).toString());
                    }
            ...
            kecamatan.addWindowListener(new WindowListener() {
                ...
                public void windowClosed(WindowEvent e) {
                    if (kecamatan.getTable().getSelectedRow() != -1) {
                        nmkecamatan.setText(
                                kecamatan.getTable().getValueAt(kecamatan.getTable().getSelectedRow(), 0).toString());
                    }
        ...
        kabupaten.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (kabupaten.getTable().getSelectedRow() != -1) {
                    nmkabupaten.setText(
                            kabupaten.getTable().getValueAt(kabupaten.getTable().getSelectedRow(), 0).toString());
                }
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.alamat,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,reg_periksa.stts_daftar,"
                            ...
                            + "%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.tgl_registrasi between ? and ? and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and "
                            +
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.alamat,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,reg_periksa.stts_daftar,"
                            ...
                            +
                            "where reg_periksa.stts_daftar like '%" + status
                            + "%' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and "
                            +
