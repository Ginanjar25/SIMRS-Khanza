...
public final class DlgPelayananLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ TAT ( Turn Around Time ) Pemeriksaan Laboratorium PK ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (rs.getDouble("permintaansampel") <= 15) {
                        ...
                        satujam++;
                            ...
                            && (rs.getDouble("permintaansampel") <= 120)) {
                        lebihsatujam++;
                ...
                if (lamajam > 0) {
                    tabMode.addRow(new Object[] {
                            ...
                            "" + Valid.SetAngka6(lamajam2 / (i - 1)), "" + Valid.SetAngka6(lamajam3 / (i - 1))
                    });
                    tabMode.addRow(new Object[] {
                            "", "", "0 - 15 Menit", ": ", "", "", "", "", "" + limabelas, "" + limabelas2,
                            "" + limabelas3
                    });
                    tabMode.addRow(new Object[] {
                            "", "", ">15 - <=30 Menit", ": ", "", "", "", "", "" + tigapuluh, "" + tigapuluh2,
                            "" + tigapuluh3
                    });
                    tabMode.addRow(new Object[] {
                    ...
                    tabMode.addRow(new Object[] {
                            "", "", ">60 - <=120 Menit", ": ", "", "", "", "", "" + lebihsatujam, "" + lebihsatujam2,
                            "" + lebihsatujam3
                    });
                    tabMode.addRow(new Object[] {
                            "", "", ">120 Menit", ": ", "", "", "", "", "" + lebihduajam, "" + lebihduajam2,
                            "" + lebihduajam3
                    });
                }
            } catch (Exception e) {
