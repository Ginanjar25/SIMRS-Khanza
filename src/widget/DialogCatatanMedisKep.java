 ...
 * @author IT
 */
public class DialogCatatanMedisKep {
      public static void show(Component parent, String catatanMedisKep) {

        boolean adaCatatan = catatanMedisKep != null && !catatanMedisKep.trim().isEmpty();
        ...
        if (adaCatatan) {
            panelUtama.add(createSection.apply("Awal Medis & Keperawatan", catatanMedisKep));
        }
