...
public final class DlgRawatJalan extends javax.swing.JDialog {
    private final DefaultTableModel tabModeDr, tabModePr, tabModeDrPr,
            ...
            TabModeTindakan, TabModeTindakan2, TabModeTindakan3, TabModeCatatan, TabModeAlergi;
    ...
    private SatuSehatCariAllergy alergi = new SatuSehatCariAllergy(null, false);
    ...
    public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaan = new DefaultTableModel(null, new Object[] {
                ...
                "Alergi",
                "L.P.(Cm)", "Plan", "Asesmen", "Inst/Impl", "Evaluasi", "NIP", "Dokter/Paramedis",
                "Profesi/Jabatan" }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
        ...
        TabModeAlergi = new DefaultTableModel(null, new Object[] {
                "P", "No.R.M.", "Nama Pasien", "Kode Dokter", "Nama Dokter", "Alergi Code", "System", "Alergi",
                "Reaksi Code", "System", "Reaksi", "Kategory", "Severity" }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
                if (colIndex == 0) {
                ...
                if (akses.getform().equals("DlgRawatJalan")) {
                    if (alergi.getTable().getSelectedRow() != -1) {
                        if (TabRawat.getSelectedIndex() == 8) {
                            KdAlergi.setText(
                                    alergi.getTable().getValueAt(alergi.getTable().getSelectedRow(), 0).toString());
                            TSystemCode.setText(
                                    alergi.getTable().getValueAt(alergi.getTable().getSelectedRow(), 1).toString());
                            TDisplayAlergi.setText(
                                    alergi.getTable().getValueAt(alergi.getTable().getSelectedRow(), 2).toString());
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgRawatJalan")) {
                    if (alergiReaction.getTable().getSelectedRow() != -1) {
                        if (TabRawat.getSelectedIndex() == 8) {
                            TReaksiCode.setText(alergiReaction.getTable()
                                    .getValueAt(alergiReaction.getTable().getSelectedRow(), 0).toString());
                            TReaksiSystem.setText(alergiReaction.getTable()
                                    .getValueAt(alergiReaction.getTable().getSelectedRow(), 1).toString());
                            TReaksiDisplay.setText(alergiReaction.getTable()
                                    .getValueAt(alergiReaction.getTable().getSelectedRow(), 2).toString());
                        }
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        button4.setText("Akses ICARE BPJS");
        ...
        cmbKesadaran.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "Compos Mentis", "Somnolence", "Sopor", "Coma", "Apatis", "Delirium", "Meninggal" }));
        ...
        BtnSeekDokter4.setName("BtnSeekDokter3");
        ...
        BtnSeekDokter4.setBounds(749, 10, 28, 23);
        ...
        BtnSeekCariAlergi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png")));
        BtnSeekCariAlergi.setMnemonic('4');
        BtnSeekCariAlergi.setToolTipText("ALt+4");
        BtnSeekCariAlergi.setName("BtnSeekCariAlergi");
        BtnSeekCariAlergi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        // baris 3
        jLabel86.setText("Reaksi :");
        jLabel86.setName("jLabel86");
        panelGlass16.add(jLabel86);
        jLabel86.setBounds(0, 70, 60, 23);
        ...
        TReaksiSystem.setEditable(false);
        TReaksiSystem.setHighlighter(null);
        TReaksiSystem.setName("TReaksiSystem");
        panelGlass16.add(TReaksiSystem);
        TReaksiSystem.setBounds(210, 70, 200, 23);

        TReaksiDisplay.setEditable(false);
        TReaksiDisplay.setHighlighter(null);
        TReaksiDisplay.setName("TReaksiDisplay");
        panelGlass16.add(TReaksiDisplay);
        TReaksiDisplay.setBounds(415, 70, 200, 23);
        ...
        BtnSeekCariReaksiAlergi.setToolTipText("ALt+4");
        BtnSeekCariReaksiAlergi.setName("BtnSeekCariReaksiAlergi");
        BtnSeekCariReaksiAlergi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSeekCariReaksiAlergiActionPerformed(evt);
            }
        });
        panelGlass16.add(BtnSeekCariReaksiAlergi);
        BtnSeekCariReaksiAlergi.setBounds(615, 70, 28, 23);

        // baris4
        jLabel87.setText("Kategory :");
        ...
        cmbKategory.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "-Pilih-", "Makanan", "Medication", "Lingkungan", "Biologis" }));
        ...
        cmbSeverity.setModel(
                new javax.swing.DefaultComboBoxModel(new String[] { "-Pilih-", "low", "high", "unable-to-assess" }));
    ...
    private void button4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
            ...
            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                ...
                if (Sequel.cekTanggalRegistrasi(TanggalRegistrasi.getText(),
                        Valid.SetTgl(DTPTgl.getSelectedItem() + "") + " " + cmbJam.getSelectedItem() + ":"
                                + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem()) == true) {
                    simpan();
                }
            }
        }
    ...
    private void BtnBatalActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnBatalActionPerformed
        ...
        TPemeriksaan.setText("");
        TPenilaian.setText("");
        TAlergi.setText(Sequel.cariIsi(
                "SELECT GROUP_CONCAT(mal.display SEPARATOR ', ') AS alergi FROM alergi aa JOIN satu_sehat_ref_allergy mal ON mal.code = aa.alergi_code WHERE aa.no_rkm_medis=?",
                TNoRM.getText()));
        TBerat.setText("");
        TTinggi.setText("");
        TNadi.setText("");
        ...
        switch (TabRawat.getSelectedIndex()) {
                        ...
                        if (tbRawatDr.getValueAt(i, 0).toString().equals("true")) {
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                ...
                                if (Sequel.cekTanggal48jam(
                                        tbRawatDr.getValueAt(i, 7).toString() + " "
                                                + tbRawatDr.getValueAt(i, 8).toString(),
                                    ...
                                    if (Sequel.cariRegistrasi(tbRawatDr.getValueAt(i, 1).toString()) > 0) {
                                        ...
                                        if (Sequel.queryutf("delete from rawat_jl_dr where no_rawat='"
                                            ...
                                            ttljmdokter = ttljmdokter
                                                    + Double.parseDouble(tbRawatDr.getValueAt(i, 11).toString());
                                            ttlkso = ttlkso
                                                    + Double.parseDouble(tbRawatDr.getValueAt(i, 12).toString());
                                            ttlpendapatan = ttlpendapatan
                                                    + Double.parseDouble(tbRawatDr.getValueAt(i, 9).toString());
                                            ttljasasarana = ttljasasarana
                                                    + Double.parseDouble(tbRawatDr.getValueAt(i, 13).toString());
                                            ttlbhp = ttlbhp
                                                    + Double.parseDouble(tbRawatDr.getValueAt(i, 14).toString());
                                            ttlmenejemen = ttlmenejemen
                                                    + Double.parseDouble(tbRawatDr.getValueAt(i, 15).toString());
                                        } else {
                                            sukses = false;
                    ...
                    if (sukses == true) {
                        ...
                        if (ttlpendapatan > 0) {
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getSuspen_Piutang_Tindakan_Ralan()
                                            + "','Suspen Piutang Tindakan Ralan','0','" + ttlpendapatan + "'",
                                    "kredit=kredit+'" + (ttlpendapatan) + "'",
                                    "kd_rek='" + akuntindakanralan.getSuspen_Piutang_Tindakan_Ralan() + "'") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getTindakan_Ralan()
                                            + "','Pendapatan Tindakan Rawat Jalan','" + ttlpendapatan + "','0'",
                                    "debet=debet+'" + (ttlpendapatan) + "'",
                                    "kd_rek='" + akuntindakanralan.getTindakan_Ralan() + "'") == false) {
                                sukses = false;
                            }
                        }
                        if (ttljmdokter > 0) {
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getBeban_Jasa_Medik_Dokter_Tindakan_Ralan()
                                            + "','Beban Jasa Medik Dokter Tindakan Ralan','0','" + ttljmdokter + "'",
                                    "kredit=kredit+'" + (ttljmdokter) + "'",
                                    "kd_rek='" + akuntindakanralan.getBeban_Jasa_Medik_Dokter_Tindakan_Ralan()
                                            + "'") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getUtang_Jasa_Medik_Dokter_Tindakan_Ralan()
                                            + "','Utang Jasa Medik Dokter Tindakan Ralan','" + ttljmdokter + "','0'",
                                    "debet=debet+'" + (ttljmdokter) + "'",
                                    "kd_rek='" + akuntindakanralan.getUtang_Jasa_Medik_Dokter_Tindakan_Ralan()
                                            + "'") == false) {
                                sukses = false;
                            }
                        }
                        if (ttlkso > 0) {
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getBeban_KSO_Tindakan_Ralan()
                                            + "','Beban KSO Tindakan Ralan','0','" + ttlkso + "'",
                                    "kredit=kredit+'" + (ttlkso) + "'",
                                    "kd_rek='" + akuntindakanralan.getBeban_KSO_Tindakan_Ralan() + "'") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getUtang_KSO_Tindakan_Ralan()
                                            + "','Utang KSO Tindakan Ralan','" + ttlkso + "','0'",
                                    "debet=debet+'" + (ttlkso) + "'",
                                    "kd_rek='" + akuntindakanralan.getUtang_KSO_Tindakan_Ralan() + "'") == false) {
                                sukses = false;
                            }
                        }
                        if (ttlmenejemen > 0) {
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getBeban_Jasa_Menejemen_Tindakan_Ralan()
                                            + "','Beban Jasa Menejemen Tindakan Ralan','0','" + ttlmenejemen + "'",
                                    "kredit=kredit+'" + (ttlmenejemen) + "'",
                                    "kd_rek='" + akuntindakanralan.getBeban_Jasa_Menejemen_Tindakan_Ralan()
                                            + "'") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getUtang_Jasa_Menejemen_Tindakan_Ralan()
                                            + "','Utang Jasa Menejemen Tindakan Ralan','" + ttlmenejemen + "','0'",
                                    "debet=debet+'" + (ttlmenejemen) + "'",
                                    "kd_rek='" + akuntindakanralan.getUtang_Jasa_Menejemen_Tindakan_Ralan()
                                            + "'") == false) {
                                sukses = false;
                            }
                        }
                        if (ttljasasarana > 0) {
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getBeban_Jasa_Sarana_Tindakan_Ralan()
                                            + "','Beban Jasa Sarana Tindakan Ralan','0','" + ttljasasarana + "'",
                                    "kredit=kredit+'" + (ttljasasarana) + "'", "kd_rek='"
                                            + akuntindakanralan.getBeban_Jasa_Sarana_Tindakan_Ralan() + "'") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getUtang_Jasa_Sarana_Tindakan_Ralan()
                                            + "','Utang Jasa Sarana Tindakan Ralan','" + ttljasasarana + "','0'",
                                    "debet=debet+'" + (ttljasasarana) + "'", "kd_rek='"
                                            + akuntindakanralan.getUtang_Jasa_Sarana_Tindakan_Ralan() + "'") == false) {
                                sukses = false;
                            }
                        }
                        if (ttlbhp > 0) {
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getHPP_BHP_Tindakan_Ralan()
                                            + "','HPP BHP Tindakan Ralan','0','" + ttlbhp + "'",
                                    "kredit=kredit+'" + (ttlbhp) + "'",
                                    "kd_rek='" + akuntindakanralan.getHPP_BHP_Tindakan_Ralan() + "'") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getPersediaan_BHP_Tindakan_Ralan()
                                            + "','Persediaan BHP Tindakan Ralan','" + ttlbhp + "','0'",
                                    "debet=debet+'" + (ttlbhp) + "'",
                                    "kd_rek='" + akuntindakanralan.getPersediaan_BHP_Tindakan_Ralan() + "'") == false) {
                                sukses = false;
                            }
                        }
                        if (sukses == true) {
            ...
            case 1:
                if (tabModePr.getRowCount() == 0) {
                    ...
                    for (i = 0; i < tbRawatPr.getRowCount(); i++) {
                        if (tbRawatPr.getValueAt(i, 0).toString().equals("true")) {
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                ...
                                if (Sequel.cekTanggal48jam(
                                        tbRawatPr.getValueAt(i, 7).toString() + " "
                                                + tbRawatPr.getValueAt(i, 8).toString(),
                                        Sequel.ambiltanggalsekarang()) == true) {
                                    if (Sequel.cariRegistrasi(tbRawatPr.getValueAt(i, 1).toString()) > 0) {
                                        JOptionPane.showMessageDialog(rootPane,
                                                "Data billing sudah terverifikasi, data tidak boleh dihapus.\nSilahkan hubungi bagian kasir/keuangan ..!!");
                                        ...
                                        if (Sequel.queryutf("delete from rawat_jl_pr where no_rawat='"
                                            ...
                                            ttljmperawat = ttljmperawat
                                                    + Double.parseDouble(tbRawatPr.getValueAt(i, 11).toString());
                                            ttlkso = ttlkso
                                                    + Double.parseDouble(tbRawatPr.getValueAt(i, 12).toString());
                                            ttlpendapatan = ttlpendapatan
                                                    + Double.parseDouble(tbRawatPr.getValueAt(i, 9).toString());
                                            ttljasasarana = ttljasasarana
                                                    + Double.parseDouble(tbRawatPr.getValueAt(i, 13).toString());
                                            ttlbhp = ttlbhp
                                                    + Double.parseDouble(tbRawatPr.getValueAt(i, 14).toString());
                                            ttlmenejemen = ttlmenejemen
                                                    + Double.parseDouble(tbRawatPr.getValueAt(i, 15).toString());
                                        } else {
                                            sukses = false;
                    ...
                    if (sukses == true) {
                        ...
                        if (ttljmperawat > 0) {
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getBeban_Jasa_Medik_Paramedis_Tindakan_Ralan()
                                            + "','Beban Jasa Medik Paramedis Tindakan Ralan','0','" + ttljmperawat
                                            + "'",
                                    "kredit=kredit+'" + (ttljmperawat) + "'",
                                    "kd_rek='" + akuntindakanralan.getBeban_Jasa_Medik_Paramedis_Tindakan_Ralan()
                                            + "'") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf("tampjurnal",
                                    "'" + akuntindakanralan.getUtang_Jasa_Medik_Paramedis_Tindakan_Ralan()
                                            + "','Utang Jasa Medik Paramedis Tindakan Ralan','" + ttljmperawat
                                            + "','0'",
                                    "debet=debet+'" + (ttljmperawat) + "'",
                                    "kd_rek='" + akuntindakanralan.getUtang_Jasa_Medik_Paramedis_Tindakan_Ralan()
                                            + "'") == false) {
                                sukses = false;
                            }
                        }
                    ...
                    for (i = 0; i < tbRawatDrPr.getRowCount(); i++) {
                        if (tbRawatDrPr.getValueAt(i, 0).toString().equals("true")) {
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                ...
                                if (Sequel.cekTanggal48jam(
                                        tbRawatDrPr.getValueAt(i, 9).toString() + " "
                                                + tbRawatDrPr.getValueAt(i, 10).toString(),
                                        Sequel.ambiltanggalsekarang()) == true) {
                                    if (Sequel.cariRegistrasi(tbRawatDrPr.getValueAt(i, 1).toString()) > 0) {
                                        JOptionPane.showMessageDialog(rootPane,
                                                "Data billing sudah terverifikasi, data tidak boleh dihapus.\nSilahkan hubungi bagian kasir/keuangan ..!!");
                                        ...
                                        if (Sequel.queryutf("delete from rawat_jl_drpr where no_rawat='"
                                            ...
                                            ttljasasarana = ttljasasarana
                                                    + Double.parseDouble(tbRawatDrPr.getValueAt(i, 16).toString());
                                            ttlbhp = ttlbhp
                                                    + Double.parseDouble(tbRawatDrPr.getValueAt(i, 17).toString());
                                            ttlmenejemen = ttlmenejemen
                                                    + Double.parseDouble(tbRawatDrPr.getValueAt(i, 18).toString());
                                        } else {
                                            sukses = false;
                                ...
                                if (Sequel.cekTanggal48jam(
                                    ...
                                    if (akses.getkode().equals(tbPemeriksaan.getValueAt(i, 23).toString())) {
                                        Sequel.queryu("delete from pemeriksaan_ralan where no_rawat='"
                                                ...
                                                "' and tgl_perawatan='" + tbPemeriksaan.getValueAt(i, 4).toString() +
                                                "' and jam_rawat='" + tbPemeriksaan.getValueAt(i, 5).toString() + "' ");
                                        if (Sequel.cariIsi("select kd_sps from dokter where kd_dokter = ?",
                                                akses.getkode()).equals("S0017")) {
                                            hapusKFR();
                                        }
                                        tabModePemeriksaan.removeRow(i);
                                        i--;
                    ...
                    for (i = 0; i < tbPemeriksaanObstetri.getRowCount(); i++) {
                        if (tbPemeriksaanObstetri.getValueAt(i, 0).toString().equals("true")) {
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                ...
                                if (Sequel.cekTanggal48jam(
                                        tbPemeriksaanObstetri.getValueAt(i, 4).toString() + " "
                    ...
                    for (i = 0; i < tbPemeriksaanGinekologi.getRowCount(); i++) {
                        if (tbPemeriksaanGinekologi.getValueAt(i, 0).toString().equals("true")) {
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                ...
                                if (Sequel.cekTanggal48jam(
                                        tbPemeriksaanGinekologi.getValueAt(i, 4).toString() + " "
                    ...
                    for (i = 0; i < tbCatatan.getRowCount(); i++) {
                        if (tbCatatan.getValueAt(i, 0).toString().equals("true")) {
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                ...
                                if (Sequel.cekTanggal48jam(
                                        tbCatatan.getValueAt(i, 4).toString() + " "
            ...
            case 8:
                if (TabModeAlergi.getRowCount() == 0) {
                    ...
                    for (i = 0; i < tbAlergi.getRowCount(); i++) {
                        if (tbAlergi.getValueAt(i, 0).toString().equals("true")) {
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                Sequel.queryu("delete from alergi where no_rkm_medis='"
                                        + tbAlergi.getValueAt(i, 1).toString() +
                ...
                if (tabModeDr.getRowCount() == 0) {
                    ...
                    Valid.MyReportqry("rptJalanDr.jasper", "report", "::[ Data Rawat Jalan Yang Ditangani Dokter ]::",
                            "select rawat_jl_dr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien," +
                                    ...
                                    "where " + tgl + " and " +
                                    "(rawat_jl_dr.no_rawat like '%" + TCari.getText().trim()
                                    ...
                                    + "%' or rawat_jl_dr.kd_dokter like '%" + TCari.getText().trim()
        ...
        try {
            if (Sequel.cariIsi("select stts from reg_periksa where no_rawat = ?", TNoRw.getText()).equals("Belum")) {
                ...
                if (i == JOptionPane.YES_OPTION) {
                    if (!Sequel.cariIsi("select stts from reg_periksa where no_rawat = ?", TNoRw.getText())
                            .equals("Sudah")) {
                        Sequel.mengedit("antripoli", "no_rawat = ?", "status=?, updated_at = now() ", 2,
                                new String[] { "2", TNoRw.getText() });
                    }
                    if (Sequel.mengedittf("reg_periksa", "no_rawat=?", "stts=?", 2,
                        ...
                        Sequel.menyimpan("mutasi_berkas", "'" + TNoRw.getText()
                                + "','Sudah Kembali',now(),'0000-00-00 00:00:00',now(),'0000-00-00 00:00:00','0000-00-00 00:00:00'",
                                "status='Sudah Kembali',kembali=now()", "no_rawat='" + TNoRw.getText() + "'");
                    }
                }
            }
                        ...
                        if (tbPemeriksaan.getSelectedRow() > -1) {
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                if (Sequel.mengedittf("pemeriksaan_ralan",
                                    ...
                                    if (Sequel.cariIsi("select kd_sps from dokter where kd_dokter = ?", akses.getkode())
                                            .equals("S0017")) {
                                    ...
                                    if (Sequel.cekTanggal48jam(
                                        ...
                                        if (Sequel.cekTanggalRegistrasi(TanggalRegistrasi.getText(),
                                            ...
                                            if (Sequel.mengedittf("pemeriksaan_ralan", "no_rawat='"
                                                    + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 1) +
                                                    "' and tgl_perawatan='"
                                                    + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 4) +
                                                    "' and jam_rawat='"
                                                    + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 5) + "'",
                                                    "no_rawat='" + TNoRw.getText() + "',suhu_tubuh='" + TSuhu.getText()
                                                            ...
                                                            + TRespirasi.getText() + "'," +
                                                            "tinggi='" + TTinggi.getText() + "',berat='"
                                                            + TBerat.getText() + "',spo2='" + SpO2.getText() + "'," +
                                                            "gcs='" + TGCS.getText() + "',kesadaran='"
                                                            + cmbKesadaran.getSelectedItem() + "'," +
                                                            "alergi='" + TAlergi.getText() + "',lingkar_perut='"
                                                            + LingkarPerut.getText() + "'," +
                                                ...
                                                tbPemeriksaan.setValueAt(SpO2.getText(), tbPemeriksaan.getSelectedRow(),
                                                        12);
                                                tbPemeriksaan.setValueAt(TGCS.getText(), tbPemeriksaan.getSelectedRow(),
                                                        13);
                                                tbPemeriksaan.setValueAt(cmbKesadaran.getSelectedItem().toString(),
                                                        tbPemeriksaan.getSelectedRow(), 14);
                                ...
                                if (Sequel.mengedittf("pemeriksaan_obstetri_ralan",
                                        "no_rawat='"
                                                + tbPemeriksaanObstetri
                                                        .getValueAt(tbPemeriksaanObstetri.getSelectedRow(), 1)
                                                +
                                                "' and tgl_perawatan='"
                                                + tbPemeriksaanObstetri
                                                        .getValueAt(tbPemeriksaanObstetri.getSelectedRow(), 4)
                                                +
                                                "' and jam_rawat='"
                                                + tbPemeriksaanObstetri
                                                        .getValueAt(tbPemeriksaanObstetri.getSelectedRow(), 5)
                                                + "'",
                                    ...
                                    if (Sequel.cekTanggalRegistrasi(TanggalRegistrasi.getText(),
                                        ...
                                        if (Sequel.mengedittf("pemeriksaan_obstetri_ralan",
                                                "no_rawat='"
                                                        ...
                                                        +
                                                        "' and jam_rawat='"
                                                        + tbPemeriksaanObstetri.getValueAt(
                                                                tbPemeriksaanObstetri.getSelectedRow(), 5)
                                                        + "'",
                                                "no_rawat='" + TNoRw.getText() + "', tgl_perawatan='"
                                                        + Valid.SetTgl(DTPTgl.getSelectedItem() + "") + "', " +
                                                        ...
                                                        + "', " +
                                                        "denominator='" + TDenominator.getText() + "', ketuban='"
                                                        + cmbKetuban.getSelectedItem() + "', feto='"
                                                        + cmbFeto.getSelectedItem() + "'") == true) {
                                            tbPemeriksaanObstetri.setValueAt(TNoRw.getText(),
                                                    tbPemeriksaanObstetri.getSelectedRow(), 1);
                                            tbPemeriksaanObstetri.setValueAt(TNoRM.getText(),
                                                    tbPemeriksaanObstetri.getSelectedRow(), 2);
                            ...
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                if (Sequel.mengedittf("pemeriksaan_ginekologi_ralan",
                                        ...
                                        "no_rawat='" + TNoRw.getText() + "', tgl_perawatan='"
                                                ...
                                                "vulva_inspekulo='" + TVulvaInspekulo.getText()
                                                + "', portio_inspekulo='" + TPortioInspekulo.getText() + "', sondage='"
                                                + TSondage.getText() + "', " +
                                ...
                                if (Sequel.cekTanggal48jam(
                                    ...
                                    if (Sequel.cekTanggalRegistrasi(TanggalRegistrasi.getText(),
                                        ...
                                        if (Sequel.mengedittf("pemeriksaan_ginekologi_ralan",
                                                "no_rawat='"
                                                        + tbPemeriksaanGinekologi.getValueAt(
                                                                tbPemeriksaanGinekologi.getSelectedRow(), 1)
                                                        +
                                                        "' and tgl_perawatan='"
                                                        + tbPemeriksaanGinekologi.getValueAt(
                                                ...
                                                "no_rawat='" + TNoRw.getText() + "', tgl_perawatan='"
                                                        ...
                                                        + TInspeksiVulva.getText() + "', inspekulo_gine='"
                                                        + TInspekuloGine.getText() + "', " +
                                                        "fluxus_gine='" + cmbFluxusGine.getSelectedItem()
                                                        + "', fluor_gine='" + cmbFluorGine.getSelectedItem() + "', " +
                                                        "vulva_inspekulo='" + TVulvaInspekulo.getText()
                                                        + "', portio_inspekulo='" + TPortioInspekulo.getText()
                                                        + "', sondage='" + TSondage.getText() + "', " +
                                                        "portio_dalam='" + TPortioDalam.getText() + "', bentuk='"
                                                        + TBentuk.getText() + "', cavum_uteri='" + TCavumUteri.getText()
                                                        + "', " +
                                                        "mobilitas='" + cmbMobilitas.getSelectedItem() + "', ukuran='"
                                                        ...
                                                        + cmbNyeriTekan.getSelectedItem() + "'," +
                                                        "adnexa_kanan='" + TAdnexaKanan.getText() + "', adnexa_kiri='"
                                                        + TAdnexaKiri.getText() + "', cavum_douglas='"
                ...
                case 7:
                    if (!Catatan.getText().trim().equals("")) {
                        if (tbCatatan.getSelectedRow() > -1) {
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                if (Sequel.mengedittf("catatan_perawatan", "no_rawat='"
                                        + tbCatatan.getValueAt(tbCatatan.getSelectedRow(), 1) +
                                ...
                                if (akses.getkode().equals(tbCatatan.getValueAt(tbCatatan.getSelectedRow(), 6))) {
                                    if (Sequel.cekTanggal48jam(
                                            tbCatatan.getValueAt(tbCatatan.getSelectedRow(), 4) + " "
                                                    + tbCatatan.getValueAt(tbCatatan.getSelectedRow(), 5),
                                            Sequel.ambiltanggalsekarang()) == true) {
                                        if (TanggalRegistrasi.getText().equals("")) {
                                            TanggalRegistrasi.setText(Sequel.cariIsi(
                                                    "select concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg) from reg_periksa where reg_periksa.no_rawat=?",
                            ...
                            if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                                if (Sequel.mengedittf("alergi",
                                        "no_rkm_medis='" + tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 1) +
                                                ...
                                                +
                                                "' and alergi_code='"
                                                + tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 5) +
                                                "' and reaction_code='"
                                                + tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 8) + "' ",
                                        "alergi_code='" + KdAlergi.getText() + "',reaction_code='"
                                                + TReaksiCode.getText() + "'," +
                                                "kategori='" + cmbKategory.getSelectedItem() + "',severity='"
                                                + cmbSeverity.getSelectedItem() + "' ") == true) {
                                    ...
                                    tbAlergi.setValueAt(TDisplayAlergi.getText(), tbAlergi.getSelectedRow(), 7);
                                    tbAlergi.setValueAt(TReaksiCode.getText(), tbAlergi.getSelectedRow(), 8);
                                    tbAlergi.setValueAt(TReaksiSystem.getText(), tbAlergi.getSelectedRow(), 9);
                                    tbAlergi.setValueAt(TReaksiDisplay.getText(), tbAlergi.getSelectedRow(), 10);
                                ...
                                if (akses.getkode().equals(tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 3))) {
                                    if (Sequel.mengedittf("alergi",
                                            "no_rkm_medis='" + tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 1)
                                                    + "' and kd_dokter='"
                                                    + tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 3)
                                                    + "' and alergi_code='"
                                                    + tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 5)
                                                    + "' and reaction_code='"
                                                    + tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 8) + "' ",
                                        ...
                                        tbAlergi.setValueAt(TReaksiSystem.getText(), tbAlergi.getSelectedRow(), 9);
                                        tbAlergi.setValueAt(TReaksiDisplay.getText(), tbAlergi.getSelectedRow(), 10);
                                        tbAlergi.setValueAt(cmbKategory.getSelectedItem(), tbAlergi.getSelectedRow(),
                                                11);
                                        tbAlergi.setValueAt(cmbSeverity.getSelectedItem(), tbAlergi.getSelectedRow(),
                                                12);
                                    }
                                } else {
                                    JOptionPane.showMessageDialog(null,
    ...
    private void BtnResepObatActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnResepObatActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            if ((Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",
                    TNoRw.getText()) > 0) && (bypassranap == false)) {
    ...
    private void ChkInput4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ChkInput3ActionPerformed
        isForm5();
    }// GEN-LAST:event_ChkInput3ActionPerformed
    ...
    private void BtnSeekCariReaksiAlergiActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSeekDokter3ActionPerformed
        akses.setform("DlgRawatJalan");
        alergiReaction.emptTeks();
        // alergi.isCek();
        alergiReaction.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        alergiReaction.setLocationRelativeTo(internalFrame1);
        alergiReaction.setVisible(true);
    }// GEN-LAST:event_BtnSeekDokter3ActionPerformed
    ...
    private void Btn5SoapActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_Btn5SoapActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            soapterakhir.setNoRM(TNoRM.getText(), KdPeg.getText(), "Ralan", TNoRw.getText());
    ...
    private void MnSOAPDokterActionPerformed(java.awt.event.ActionEvent evt) {
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            if (tbPemeriksaan.getSelectedRow() > -1) {
                if (!Sequel.CariDokter(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 23).toString())
                        .equals("")) {
                    Map<String, Object> param = new HashMap<>();
                    param.put("namars", akses.getnamars());
                    param.put("alamatrs", akses.getalamatrs());
                    ...
                    param.put("finger",
                            "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                                    ...
                                    + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 24).toString() + "\nID "
                                    + (finger.equals("")
                                            ? tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 23).toString()
                                            : finger)
                                    + "\n" + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 4).toString()
                                    + " " + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 5).toString());
                    Valid.MyReportqry("rptFormulirSOAPDokter.jasper", "report", "::[ Formulir SOAP Dokter ]::",
                            "select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat,pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,"
                                    ...
                                    + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 1).toString() + "' and "
                                    +
                                    "pemeriksaan_ralan.tgl_perawatan='"
                                    + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 4).toString()
                                    + "' and pemeriksaan_ralan.jam_rawat='"
                                    + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 5).toString() + "'",
                            param);
                } else {
    ...
    private void MnCopySOAPActionPerformed(java.awt.event.ActionEvent evt) {
        copypastesoapralan.SetCatatanPasien(TKeluhan.getText(), TPemeriksaan.getText(), TPenilaian.getText(),
    ...
    private void MnSOAPPetugasActionPerformed(java.awt.event.ActionEvent evt) {
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            if (tbPemeriksaan.getSelectedRow() > -1) {
                if (!Sequel.CariPetugas(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 23).toString())
                        .equals("")) {
                    Map<String, Object> param = new HashMap<>();
                    param.put("namars", akses.getnamars());
                    param.put("alamatrs", akses.getalamatrs());
                    ...
                    param.put("finger",
                            "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                                    ...
                                    + "\n" + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 4).toString()
                                    + " " + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 5).toString());
                    String kodedokter = Sequel.cariIsi(
                            "select reg_periksa.kd_dokter from reg_periksa where reg_periksa.no_rawat=?",
                            tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 1).toString());
                    String namadokter = Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",
                            kodedokter);
                    ...
                    Valid.MyReportqry("rptFormulirSOAPPetugas.jasper", "report", "::[ Formulir SOAP Petugas ]::",
                            "select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat,pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,"
                                    ...
                                    "inner join kelurahan inner join kecamatan inner join kabupaten on pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab inner join pemeriksaan_ralan on pemeriksaan_ralan.no_rawat=reg_periksa.no_rawat "
                                    +
                                    "inner join pegawai on pemeriksaan_ralan.nip=pegawai.nik inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter where reg_periksa.no_rawat='"
                                    + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 1).toString() + "' and "
                                    +
                                    "pemeriksaan_ralan.tgl_perawatan='"
                                    + tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(), 4).toString()
            ...
            if ((Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",
                ...
                if (Sequel.cariRegistrasi(TNoRw.getText()) > 0) {
                    ...
                    if (kd_pj.equals(kodebpjs.getKodeBPJS())) {
                        String pilihaniterasi = (String) JOptionPane.showInputDialog(null, "Silahkan pilih iterasi..!!",
                                "Pilihan Resep Iterasi", JOptionPane.QUESTION_MESSAGE, null,
                                new Object[] { "Iterasi 1x", "Iterasi 2x", "Batal" }, "Iterasi 1x");
    ...
    private widget.Button BtnSkorBromagePascaAnestesi, BtnPenilaianPreInduksi, BtnHasilPemeriksaanUSGUrologi,
            ...
            BtnHasilEndoskopiTelinga, BtnPenilaianPasienImunitasRendah, BtnCatatanKeseimbanganCairan,
            BtnCatatanObservasiCHBP,
            BtnCatatanObservasiInduksiPersalinan, BtnPermintaanKonsultasiMedik, BtnSkriningMerokokUsiaRemaja,
            BtnSkriningKekerasanPadaWanita, BtnSkriningObesitas, BtnSkriningRisikoKankerPayudara,
            BtnSkriningRisikoKankerParu,
            BtnSkriningKesehatanGigiMulutremaja, BtnSkriningTBC, BtnCatatanAnastesiSedasi, BtnSkriningPUMA,
            BtnSkriningAdiksiNikotin, BtnSkriningThalassemia, BtnSkriningInstrumenSDQ, BtnSkriningInstrumenSRQ,
            BtnChecklistPemberianFibrinolitik, BtnSkriningKankerKolorektal, BtnPenilaianPsikologKlinis,
            BtnPenilaianDerajatDehidrasi, BtnHasilPemeriksaanECHO, BtnPenilaianBayiBaruLahir,
            BtnSkriningDiabetesMelitus,
            BtnLaporanTindakan, BtnPelaksanaanInformasiEdukasi, BtnLayananKedokteranFisikRehabilitasi,
            BtnSkriningKesehatanGigiMulutBalita, BtnSkriningAnemia, BtnSkriningHipertensi,
            BtnSkriningKesehatanPenglihatan,
            BtnCatatanObservasiHemodialisa, BtnSkriningKesehatanGigiMulutDewasa, BtnSkriningRisikoKankerServiks,
            BtnCatatanCairanHemodialisa, BtnSkriningKesehatanGigiMulutLansia, BtnSkriningIndraPendengaran,
            BtnCatatanPengkajianPaskaOperasi, BtnSkriningFrailtySyndrome, BtnCatatanObservasiBayi,
            BtnChecklistKesiapanAnestesi, BtnHasilPemeriksaanSlitLamp, BtnHasilPemeriksaanOCT, BtnSkriningInstrumenACRS,
            BtnChecklistKriteriaMasukNICU, BtnChecklistKriteriaMasukPICU, BtnSkriningInstrumenMentalEmosional,
            BtnSkriningInstrumenAMT, BtnSkriningPneumoniaSeverityIndex, BtnAwalMedisJantung, BtnAwalMedisUrologi,
            BtnHasilPemeriksaanTreadmill, BtnHasilPemeriksaanECHOPediatrik, BtnSkriningCURB65, BtnSkriningGiziKehamilan,
            BtnResepIterasiBPJS, BtnPermintaanKonsultasiPerawat;
    ...
    public void isCek() {
        ...
        if (Sequel.cariInteger("SELECT COUNT(dr.kd_dokter) FROM dokter dr WHERE dr.kd_dokter=? ",
                akses.getkode()) > 0) {
            DTPTgl.setEditable(false);
            DTPTgl.setEnabled(false);
            ChkJln.setEnabled(false);
    ...
    private void tampilAlergi() {
        ...
        try {
            ps7 = koneksi.prepareStatement(
                    "SELECT alg.no_rkm_medis, ps.nm_pasien, alg.kd_dokter, dr.nm_dokter, malg.code, malg.system, malg.display, algr.kode, algr.system, algr.display, alg.kategori, alg.severity  FROM alergi alg\n"
                            +
                            "JOIN dokter dr ON dr.kd_dokter = alg.kd_dokter \n" +
                            "JOIN pasien ps ON ps.no_rkm_medis = alg.no_rkm_medis\n" +
                            "JOIN satu_sehat_ref_allergy malg ON malg.code = alg.alergi_code\n" +
                            "JOIN satu_sehat_ref_allergy_reaction algr ON algr.kode = alg.reaction_code where alg.no_rkm_medis like ? ");
            try {
    ...
    private void getDataPemeriksaan() {
        if (tbPemeriksaan.getSelectedRow() != -1) {
            ...
            // TAlergi.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),
            // 17).toString());
            TAlergi.setText(Sequel.cariIsi(
                    "SELECT GROUP_CONCAT(mal.display SEPARATOR ', ') AS alergi FROM alergi aa JOIN satu_sehat_ref_allergy mal ON mal.code = aa.alergi_code WHERE aa.no_rkm_medis=?",
                    TNoRM.getText()));
    ...
    private void getDataAlergi() {
        if (tbAlergi.getSelectedRow() != -1) {
            KdDok4.setText(tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 3).toString());
            TDokter4.setText(tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 4).toString());

            KdAlergi.setText(tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 5).toString());
            ...
            TReaksiCode.setText(tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 8).toString());
            ...
            cmbKategory.setSelectedItem(tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 11).toString());
            cmbSeverity.setSelectedItem(tbAlergi.getValueAt(tbAlergi.getSelectedRow(), 12).toString());
        }
    }
    ...
    public void setCaraBayar(String no_rawat) {
        String result = "";
        String cara_bayar1 = Sequel.cariIsi(
                "SELECT penjab.png_jawab FROM reg_periksa inner join penjab on penjab.kd_pj = reg_periksa.kd_pj where reg_periksa.no_rawat = ?",
                no_rawat);
        String cara_bayar2 = Sequel.cariIsi(
                "SELECT CASE WHEN penjab.png_jawab IS NULL OR penjab_reg.kd_pj = '-' THEN '' WHEN penjab_reg.kd_pj = reg_periksa.kd_pj THEN '' ELSE CONCAT(' - ', penjab.png_jawab) END AS cara_bayar2 FROM reg_periksa\n"
                        +
                        "LEFT JOIN penjab_reg on penjab_reg.no_rawat = reg_periksa.no_rawat\n" +
                        "LEFT JOIN penjab on penjab.kd_pj = penjab_reg.kd_pj\n" +
                        "WHERE reg_periksa.no_rawat=?\n" +
                        "AND penjab_reg.order != '1'",
                no_rawat);
        String kelas = Sequel.cariIsi(
                "SELECT COALESCE(bridging_sep.klsrawat, '') AS kelas FROM bridging_sep where bridging_sep.no_rawat = ? ",
                no_rawat);
        String PRB = Sequel.cariIsi(
                "SELECT bpjs_prb.prb as prb FROM bpjs_prb INNER JOIN bridging_sep ON bridging_sep.no_sep = bpjs_prb.no_sep WHERE bridging_sep.no_rawat = ? ",
                no_rawat);
        ...
        if (cara_bayar2.isEmpty()) {
            ...
            if (cara_bayar1.contains("BPJS")) {
                ...
                result = cara_bayar1 + (cara_bayar2.contains("BPJS") ? cara_bayar2 + " " + kelas + PRB
                        : " " + kelas + PRB + cara_bayar2);
            }
        }
        // result = cara_bayar1 + (cara_bayar2.contains("BPJ") ? cara_bayar2 +" "+ kelas
        // + PRB : " "+ kelas +PRB + cara_bayar2);
        ...
        try {
            ...
            for (i = 0; i < TabModeTindakan.getRowCount(); i++) {
                if (TabModeTindakan.getValueAt(i, 0).toString().equals("true")) {
                    ...
                    // totaltnd[index] = Double.parseDouble(TabModeTindakan.getValueAt(i,
                    // 4).toString());
                    // bagianrs[index] = Double.parseDouble(TabModeTindakan.getValueAt(i,
                    // 5).toString());
                    // bhp[index] = Double.parseDouble(TabModeTindakan.getValueAt(i, 6).toString());
                    // jmdokter[index] = Double.parseDouble(TabModeTindakan.getValueAt(i,
                    // 7).toString());
                    // jmperawat[index] = Double.parseDouble(TabModeTindakan.getValueAt(i,
                    // 8).toString());
                    // kso[index] = Double.parseDouble(TabModeTindakan.getValueAt(i, 9).toString());
                    // menejemen[index] = Double.parseDouble(TabModeTindakan.getValueAt(i,
                    // 10).toString());
                    // index++;
                }
            }
        ...
        try {
            ...
            if (sukses == true) {
                ...
                if (ttlpendapatan > 0) {
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getSuspen_Piutang_Tindakan_Ralan()
                                    + "','Suspen Piutang Tindakan Ralan','" + ttlpendapatan + "','0'",
                            "debet=debet+'" + (ttlpendapatan) + "'",
                            "kd_rek='" + akuntindakanralan.getSuspen_Piutang_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                    }
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getTindakan_Ralan() + "','Pendapatan Tindakan Rawat Inap','0','"
                                    + ttlpendapatan + "'",
                            "kredit=kredit+'" + (ttlpendapatan) + "'",
                            "kd_rek='" + akuntindakanralan.getTindakan_Ralan() + "'") == false) {
                        sukses = false;
                ...
                if (ttljmdokter > 0) {
                    if (Sequel.menyimpantf("tampjurnal",
                            ...
                            "debet=debet+'" + (ttljmdokter) + "'", "kd_rek='"
                                    + akuntindakanralan.getBeban_Jasa_Medik_Dokter_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                    }
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getUtang_Jasa_Medik_Dokter_Tindakan_Ralan()
                                    + "','Utang Jasa Medik Dokter Tindakan Ralan','0','" + ttljmdokter + "'",
                            "kredit=kredit+'" + (ttljmdokter) + "'", "kd_rek='"
                                    + akuntindakanralan.getUtang_Jasa_Medik_Dokter_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                    }
                }
                if (ttlkso > 0) {
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getBeban_KSO_Tindakan_Ralan() + "','Beban KSO Tindakan Ralan','"
                                    + ttlkso + "','0'",
                            "debet=debet+'" + (ttlkso) + "'",
                            "kd_rek='" + akuntindakanralan.getBeban_KSO_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                    ...
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getUtang_KSO_Tindakan_Ralan() + "','Utang KSO Tindakan Ralan','0','"
                                    + ttlkso + "'",
                            "kredit=kredit+'" + (ttlkso) + "'",
                            "kd_rek='" + akuntindakanralan.getUtang_KSO_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                ...
                if (ttljasasarana > 0) {
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getBeban_Jasa_Sarana_Tindakan_Ralan()
                                    + "','Beban Jasa Sarana Tindakan Ralan','" + ttljasasarana + "','0'",
                            "debet=debet+'" + (ttljasasarana) + "'",
                            "kd_rek='" + akuntindakanralan.getBeban_Jasa_Sarana_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                    }
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getUtang_Jasa_Sarana_Tindakan_Ralan()
                                    + "','Utang Jasa Sarana Tindakan Ralan','0','" + ttljasasarana + "'",
                            "kredit=kredit+'" + (ttljasasarana) + "'",
                            "kd_rek='" + akuntindakanralan.getUtang_Jasa_Sarana_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                    }
                }
                if (ttlbhp > 0) {
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getHPP_BHP_Tindakan_Ralan() + "','HPP BHP Tindakan Ralan','"
                                    + ttlbhp + "','0'",
                            "debet=debet+'" + (ttlbhp) + "'",
                            "kd_rek='" + akuntindakanralan.getHPP_BHP_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                    ...
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getPersediaan_BHP_Tindakan_Ralan()
                                    + "','Persediaan BHP Tindakan Ralan','0','" + ttlbhp + "'",
                            "kredit=kredit+'" + (ttlbhp) + "'",
                            "kd_rek='" + akuntindakanralan.getPersediaan_BHP_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                    }
                ...
                if (ttlmenejemen > 0) {
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getBeban_Jasa_Menejemen_Tindakan_Ralan()
                                    + "','Beban Jasa Menejemen Tindakan Ralan','" + ttlmenejemen + "','0'",
                            "debet=debet+'" + (ttlmenejemen) + "'",
                            "kd_rek='" + akuntindakanralan.getBeban_Jasa_Menejemen_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                    }
                    if (Sequel.menyimpantf("tampjurnal",
                            "'" + akuntindakanralan.getUtang_Jasa_Menejemen_Tindakan_Ralan()
                                    + "','Utang Jasa Menejemen Tindakan Ralan','0','" + ttlmenejemen + "'",
                            "kredit=kredit+'" + (ttlmenejemen) + "'",
                            "kd_rek='" + akuntindakanralan.getUtang_Jasa_Menejemen_Tindakan_Ralan() + "'") == false) {
                        sukses = false;
                    }
                }
                if (sukses == true) {
    ...
    private void inputResep() {
        ...
        if (!resepobat.isVisible()) {
            resepobat.setNoRm(TNoRw.getText(), DTPTgl.getDate(), cmbJam.getSelectedItem().toString(),
    ...
    private void initRawatJalan() {
        ...
        BtnLayananKedokteranFisikRehabilitasi
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        ...
        BtnLayananKedokteranFisikRehabilitasi
                .addActionListener(this::BtnLayananKedokteranFisikRehabilitasiActionPerformed);
        ...
        BtnSkriningKesehatanGigiMulutLansia
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        ...
        BtnSkriningKesehatanGigiMulutDewasa
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        ...
        BtnSkriningInstrumenMentalEmosional
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        ...
        BtnSkriningPneumoniaSeverityIndex
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
                        ...
                        if (akses.getkode().equals("Admin Utama") || jabatan.equals("J005")) {
                            if (Sequel.menyimpantf("pemeriksaan_ralan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                    "Data", 21, new String[] {
                                            ...
                                            SpO2.getText(), TGCS.getText(), cmbKesadaran.getSelectedItem().toString(),
    ...
    public void editLayananUjiFungsiKFR() {
        String pemeriksaan_fungsi = TPemeriksaan.getText() + " Suhu:" + TSuhu.getText() + ",Tensi:" + TTensi.getText()
                + ",Nadi:" + TNadi.getText()
                + ",RR:" + TRespirasi.getText() + ",TB:" + TTinggi.getText() + ",BB:" + TBerat.getText() + ",SpO2:"
                + SpO2.getText() + ",GCS:" + TGCS.getText() + ",Kesadaran:" + cmbKesadaran.getSelectedItem().toString();

        Sequel.mengedit("uji_fungsi_kfr", "no_rawat = '" + TNoRw.getText() + "'",
                "diagnosis_fungsional = '" + TPenilaian.getText() + "'");
        Sequel.mengedit("layanan_kfr", "no_rawat = '" + TNoRw.getText() + "'",
                "anamnesa = '" + TKeluhan.getText() + "', pemeriksaan_fisik_fungsi='" + pemeriksaan_fungsi
                        + "', diagnosa_medis='" + TPenilaian.getText() + "', "
                        + "tata_laksana_kfr= '" + TindakLanjut.getText() + "', anjuran='" + TInstruksi.getText()
                        + "', evaluasi='" + TEvaluasi.getText() + "'");
    }
    ...
    public void simpanLayananUjiFungsiKFR() {
        ...
        if (Sequel.cariInteger("select count(no_rawat) from layanan_kfr where layanan_kfr.no_rawat = ?",
                TNoRw.getText()) == 0) {
    ...
    private boolean checkMismatch() {
        ...
        if (mismatches.size() >= 1) {
            ...
            pesan.append("PERINGATAN: Ditemukan ").append(mismatches.size())
                    .append(" Tindakan yg tidak sesuai dengan Cara Bayar!\n\n");
            ...
            for (CheckPenjabMissmatch.PenjabMismatch mismatch : mismatches) {
                pesan.append(counter).append(". ").append(mismatch.getJenisTindakan()).append("-")
                        .append(mismatch.getNmPerawatan()).append(" (").append(mismatch.getKdJenisPrw()).append(")")
                        .append("\n");
                counter++;
            }
            pesan.append("Silahkan ganti tindakan tersebut terlebih dahulu !!!");

            JOptionPane.showMessageDialog(null, pesan.toString(), "Konfirmasi Mismatch Penjab",
