...
public class DlgCatatan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Catatan Untuk Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (!TCatatan.getText().trim().equals("")) {
                Sequel.menyimpan3("catatan_pasien", "?,?", 2, new String[] { TNoRM.getText(), TCatatan.getText() },
                        "no_rkm_medis=?", "catatan=?", 2, new String[] { TCatatan.getText(), TNoRM.getText() });
            }

            if (Sequel.cariInteger("SELECT count(no_rawat) from catatan_registrasi where no_rawat=? and status = '1'",
                    TNoRawat.getText()) > 0) {
                Sequel.mengedit("catatan_registrasi", "no_rawat='" + TNoRawat.getText() + "' and status='1'",
                        "catatan='" + TCatatanReg.getText() + "',updated_at=now()");
            } else {
                Sequel.menyimpan2("catatan_registrasi", "?,?,'1', now(), now()", 2,
                        new String[] { TNoRawat.getText(), TCatatanReg.getText() });
            }

            // if(!TCatatanReg.getText().trim().equals("") &&
            // !TNoRawat.getText().trim().equals("")){
            // Sequel.menyimpan3("catatan_registrasi","?,?,'1', now(), now()",2,new
            // String[]{TNoRawat.getText(),TCatatanReg.getText()},"no_rawat=? and
            // status='1'","catatan=?,updated_at=now()",2,new
            // String[]{TCatatanReg.getText(),TNoRawat.getText()});
            // }
            // BtnKeluarActionPerformed(evt);
            tampilCatatan();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnEditActionPerformed
        if (TNoRM.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (TCatatan.getText().trim().equals("")) {
                ...
                Sequel.mengedit("catatan_pasien", "no_rkm_medis='" + TNoRM.getText() + "'",
            ...
            if (TCatatanReg.getText().trim().equals("")) {
                ...
                Sequel.mengedit2("catatan_registrasi", "no_rawat=? and status='1'", "catatan=?, updated_at=now()", 2,
                        new String[] {
    ...
    private void BtnHapusCatatanRegActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnHapusCatatanRegActionPerformed
        // Sequel.mengedit("catatan_registrasi","no_rawat='"+TNoRawat.getText()+"' and
        // status='1'","status='0', updated_at=now()");

        Sequel.mengedit2("catatan_registrasi", "no_rawat=? and status='1'", "status='0', updated_at=now()", 1,
                new String[] {
                        TNoRawat.getText()
                });
    ...
    public void setNoRm(String norm, String no_rawat) {
        ...
        // Sequel.cariIsi(
        // "select catatan_pasien.catatan from catatan_pasien where
        // catatan_pasien.no_rkm_medis=?",
        // TCatatan,
        // TNoRM.getText()
        // );
        ...
        if (TNoRawat.getText().trim().equals("")) {
            ...
            TCatatanReg.setEditable(true);
            // Sequel.cariIsi("select catatan_registrasi.catatan from catatan_registrasi
            // where catatan_registrasi.no_rawat=? and catatan_registrasi.status = '1'
            // ",TCatatanReg,TNoRawat.getText());
        }
