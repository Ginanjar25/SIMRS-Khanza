                            ...
                            while (rs.next()) {
                                try {
                                    ...
                                    if (nameNode.path("code").asText().equals("200")) {
                                        ...
                                        if (!datajam.equals("")) {
                                            Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?,?,?,?", "task id", 6, new String[]{rs.getString("no_rawat_batal"), "99", datajam, "Sudah", "", ""});
                        ...
                        try {
                            ...
                            while (rs.next()) {
                                ...
                                try {
                                    ...
                                    while (rs2.next()) {
                                        if (rs2.getString("taskid").equals("3") && rs3.getString("statuskirim").equals("Sudah")) {
                                            task3 = "Sudah";
                                        }
                                        if (rs2.getString("taskid").equals("4") && rs3.getString("statuskirim").equals("Sudah")) {
                                            task4 = "Sudah";
                                        }
                                        if (rs2.getString("taskid").equals("5") && rs3.getString("statuskirim").equals("Sudah")) {
                                            task5 = "Sudah";
                                        }
                                        if (rs2.getString("taskid").equals("6") && rs3.getString("statuskirim").equals("Sudah")) {
                                            task6 = "Sudah";
                                        }
                                        if (rs2.getString("taskid").equals("7") && rs3.getString("statuskirim").equals("Sudah")) {
                                            task7 = "Sudah";
                                        }
                                        if (rs2.getString("taskid").equals("99") && rs3.getString("statuskirim").equals("Sudah")) {
                                            task99 = "Sudah";
                                        }
                                    }
                                } catch (Exception ex) {
                                ...
                                if (task5.equals("")) {
                                    ...
                                    //datajam = Sequel.cariIsi("select DATE_ADD(concat(pemeriksaan_ralan.tgl_perawatan,' ',pemeriksaan_ralan.jam_rawat),interval 2 minute) from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=?", rs.getString("no_rawat"));
                                    //}
                                    datajam = Sequel.cariIsi("select DATE_ADD(concat(pemeriksaan_ralan.tgl_perawatan,' ',pemeriksaan_ralan.jam_rawat),interval 2 minute) from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=?", rs.getString("no_rawat"));
                                    if (!datajam.equals("")) {
